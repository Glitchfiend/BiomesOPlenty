...
public class WorldGenFungi2 extends WorldGenerator
{
    public WorldGenFungi2(boolean var1)
    {
        super(var1);
    }
                        ...
                        if ((var13 == Block.grass.blockID || var24 == Block.dirt.blockID) && var4 < 256 - var6 - 1)
                        {
                            if ((var14 == Block.grass.blockID || var24 == Block.dirt.blockID) && var4 < 256 - var6 - 1)
                            {
                                ...
                                for (var19 = 0; var19 < var6 - var18; ++var19)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(var1, var3, var4 + var19, var5, Block.wood.blockID, 2);
                                        this.setBlockAndMetadata(var1, var3 - 1, var4 + var19, var5, Block.wood.blockID, 2);
                                        this.setBlockAndMetadata(var1, var3, var4 + var19, var5 - 1, Block.wood.blockID, 2);
                                        this.setBlockAndMetadata(var1, var3 - 1, var4 + var19, var5 - 1, Block.wood.blockID, 2);
                                        this.setBlockAndMetadata(var1, var3 - 1, var4 + var19, var5 - 2, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3, var4 + var19, var5 - 2, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3 + 1, var4 + var19, var5 - 1, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3 + 1, var4 + var19, var5, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3, var4 + var19, var5 + 1, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3 - 1, var4 + var19, var5 + 1, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3 - 2, var4 + var19, var5 - 1, Block.leaves.blockID, 0);
                                        this.setBlockAndMetadata(var1, var3 - 2, var4 + var19, var5, Block.leaves.blockID, 0);
                                    }
                                }
