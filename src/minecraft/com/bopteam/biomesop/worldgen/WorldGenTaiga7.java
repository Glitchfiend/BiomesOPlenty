...
public class WorldGenTaiga7 extends WorldGenerator
{
    public WorldGenTaiga7(boolean par1)
    {
        super(par1);
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        int var8 = var6 - var7;
        int var9 = 2 + par2Random.nextInt(4);
        boolean var10 = true;

        if (par4 >= 1 && par4 + var6 + 1 <= 100)
        {
            int var11;
            int var13;
            int var15;
            ...
            else
            {
                ...
                if ((var11 == Block.grass.blockID || var11 == Block.dirt.blockID) && par4 < 100 - var6 - 1)
                {
