...
public class WorldGenCrag extends WorldGenerator
{
    ...
    public WorldGenCrag(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenCrag(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((var8 == Block.gravel.blockID) && par4 < 256 - var6 - 1)
                {
                    this.setBlock(par1World, par3, par4 - 1, par5, Block.gravel.blockID);
                    var9 = 6;
                    byte var18 = 0;
                    int var13;
                    int var14;
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlock(par1World, var14, var11, var16, Block.gravel.blockID);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        if (var12 == 0 || var12 == Block.gravel.blockID)
                        {
                            this.setBlock(par1World, par3, par4 + var11, par5, Block.gravel.blockID);
                    ...
                    if (this.vinesGrow)
                    {
                        for (var11 = par4 - 3 + var6; var11 <= par4 + var6; ++var11)
                        {
                            ...
                            for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                            {
                                ...
                                {
                                    if (par1World.getBlockId(var14, var11, var15) == Block.gravel.blockID)
                                    {
