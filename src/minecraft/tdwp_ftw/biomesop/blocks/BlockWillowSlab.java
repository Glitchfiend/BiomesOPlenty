...
public class BlockWillowSlab extends BlockHalfSlab
{
    ...
    public BlockWillowSlab(int par1, boolean par2)
    {
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("BiomesOPlenty:willowplank");
	}
    ...
    {
        return BOPBlocks.willowSingleSlab.blockID;
    }
    ...
    {
        return new ItemStack(BOPBlocks.willowSingleSlab.blockID, 2, par1 & 7);
    }
...
//    }
    ...
    {
        if (par1 != BOPBlocks.willowDoubleSlab.blockID)
        {
