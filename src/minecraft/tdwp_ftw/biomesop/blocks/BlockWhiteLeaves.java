...
public class BlockWhiteLeaves extends BlockLeavesBase
{
    ...
    public BlockWhiteLeaves(int par1, int par2)
    {
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == mod_BiomesOPlenty.whiteLeaves.blockID)
                        {
                    ...
                    for (var12 = -var7; var12 <= var7; ++var12)
                    {
                        for (var13 = -var7; var13 <= var7; ++var13)
                        {
                            for (var14 = -var7; var14 <= var7; ++var14)
                            {
                                ...
                                if (var15 == mod_BiomesOPlenty.cherryWood.blockID)
                                {
                                    this.adjacentTreeBlocks[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = 0;
                                }
                                else if (var15 == mod_BiomesOPlenty.whiteLeaves.blockID)
                                {
    ...
    {
        return mod_BiomesOPlenty.whiteSapling.blockID;
    }
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        if (!par1World.isRemote && par2EntityPlayer.getCurrentEquippedItem() != null && par2EntityPlayer.getCurrentEquippedItem().itemID == Item.shears.itemID)
        {
            ...
            this.dropBlockAsItem_do(par1World, par3, par4, par5, new ItemStack(mod_BiomesOPlenty.whiteLeaves.blockID, 1, par6 & 3));
        }
        else
        {
