...
{
    protected BlockToadstool(int par1, int par2, Material par3Material)
    {
    ...
    public BlockToadstool(int par1, int par2)
    {
    ...
    {
        return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == Block.mycelium.blockID;
    }
