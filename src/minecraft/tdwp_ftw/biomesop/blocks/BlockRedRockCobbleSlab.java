...
public class BlockRedRockCobbleSlab extends BlockHalfSlab
{
    ...
    public BlockRedRockCobbleSlab(int par1, boolean par2)
    {
    ...
    {
        return BOPBlocks.redRockCobbleSingleSlab.blockID;
    }
    ...
    {
        return new ItemStack(BOPBlocks.redRockCobbleSingleSlab.blockID, 2, par1 & 7);
    }
...
//    }
    ...
    {
        if (par1 != BOPBlocks.redRockCobbleDoubleSlab.blockID)
        {
