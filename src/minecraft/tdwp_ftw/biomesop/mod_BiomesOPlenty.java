...
import tdwp_ftw.biomesop.blocks.BlockAcaciaLeaves;
import tdwp_ftw.biomesop.blocks.BlockAcaciaLog;
import tdwp_ftw.biomesop.blocks.BlockAcaciaPlank;
import tdwp_ftw.biomesop.blocks.BlockAcaciaSapling;
import tdwp_ftw.biomesop.blocks.BlockAcaciaSlab;
import tdwp_ftw.biomesop.blocks.BlockAcaciaStairs;
import tdwp_ftw.biomesop.blocks.BlockAlgae;
import tdwp_ftw.biomesop.blocks.BlockAmethystOre;
import tdwp_ftw.biomesop.blocks.BlockAmethystBlock;
import tdwp_ftw.biomesop.blocks.BlockAppleLeaves;
import tdwp_ftw.biomesop.blocks.BlockAppleLeavesFruitless;
import tdwp_ftw.biomesop.blocks.BlockAppleSapling;
import tdwp_ftw.biomesop.blocks.BlockAsh;
import tdwp_ftw.biomesop.blocks.BlockAshStone;
import tdwp_ftw.biomesop.blocks.BlockAutumnLeaves;
import tdwp_ftw.biomesop.blocks.BlockBamboo;
import tdwp_ftw.biomesop.blocks.BlockBambooLeaves;
import tdwp_ftw.biomesop.blocks.BlockBambooThatching;
import tdwp_ftw.biomesop.blocks.BlockBarley;
import tdwp_ftw.biomesop.blocks.BlockBlueFlower;
import tdwp_ftw.biomesop.blocks.BlockBlueLeaves;
import tdwp_ftw.biomesop.blocks.BlockBrownSapling;
import tdwp_ftw.biomesop.blocks.BlockBush;
import tdwp_ftw.biomesop.blocks.BlockCattail;
import tdwp_ftw.biomesop.blocks.BlockCherryLog;
import tdwp_ftw.biomesop.blocks.BlockCherryPlank;
import tdwp_ftw.biomesop.blocks.BlockCherrySlab;
import tdwp_ftw.biomesop.blocks.BlockCherryStairs;
import tdwp_ftw.biomesop.blocks.BlockCragRock;
import tdwp_ftw.biomesop.blocks.BlockDarkLeaves;
import tdwp_ftw.biomesop.blocks.BlockDarkLog;
import tdwp_ftw.biomesop.blocks.BlockDarkPlank;
import tdwp_ftw.biomesop.blocks.BlockDarkSapling;
import tdwp_ftw.biomesop.blocks.BlockDarkSlab;
import tdwp_ftw.biomesop.blocks.BlockDarkStairs;
import tdwp_ftw.biomesop.blocks.BlockDeadGrass;
import tdwp_ftw.biomesop.blocks.BlockDeadLeaves;
import tdwp_ftw.biomesop.blocks.BlockDeadLog;
import tdwp_ftw.biomesop.blocks.BlockDeathbloom;
import tdwp_ftw.biomesop.blocks.BlockDesertGrass;
import tdwp_ftw.biomesop.blocks.BlockDesertSprouts;
import tdwp_ftw.biomesop.blocks.BlockDriedDirt;
import tdwp_ftw.biomesop.blocks.BlockDuneGrass;
import tdwp_ftw.biomesop.blocks.BlockFirLeaves;
import tdwp_ftw.biomesop.blocks.BlockFirLog;
import tdwp_ftw.biomesop.blocks.BlockFirPlank;
import tdwp_ftw.biomesop.blocks.BlockFirSapling;
import tdwp_ftw.biomesop.blocks.BlockFirSlab;
import tdwp_ftw.biomesop.blocks.BlockFirStairs;
import tdwp_ftw.biomesop.blocks.BlockGiantFlowerRed;
import tdwp_ftw.biomesop.blocks.BlockGiantFlowerStem;
import tdwp_ftw.biomesop.blocks.BlockGiantFlowerYellow;
import tdwp_ftw.biomesop.blocks.BlockGlowFlower;
import tdwp_ftw.biomesop.blocks.BlockHardDirt;
import tdwp_ftw.biomesop.blocks.BlockHardIce;
import tdwp_ftw.biomesop.blocks.BlockHardSand;
import tdwp_ftw.biomesop.blocks.BlockHighGrassBottom;
import tdwp_ftw.biomesop.blocks.BlockHighGrassTop;
import tdwp_ftw.biomesop.blocks.BlockHolyGrass;
import tdwp_ftw.biomesop.blocks.BlockHolyLeaves;
import tdwp_ftw.biomesop.blocks.BlockHolyLog;
import tdwp_ftw.biomesop.blocks.BlockHolyPlank;
import tdwp_ftw.biomesop.blocks.BlockHolySapling;
import tdwp_ftw.biomesop.blocks.BlockHolySlab;
import tdwp_ftw.biomesop.blocks.BlockHolyStairs;
import tdwp_ftw.biomesop.blocks.BlockHolyStone;
import tdwp_ftw.biomesop.blocks.BlockHolyTallGrass;
import tdwp_ftw.biomesop.blocks.BlockHydrangea;
import tdwp_ftw.biomesop.blocks.BlockMagicLog;
import tdwp_ftw.biomesop.blocks.BlockMagicPlank;
import tdwp_ftw.biomesop.blocks.BlockMagicSapling;
import tdwp_ftw.biomesop.blocks.BlockMagicSlab;
import tdwp_ftw.biomesop.blocks.BlockMagicStairs;
import tdwp_ftw.biomesop.blocks.BlockMangroveLeaves;
import tdwp_ftw.biomesop.blocks.BlockMangroveLog;
import tdwp_ftw.biomesop.blocks.BlockMangrovePlank;
import tdwp_ftw.biomesop.blocks.BlockMangroveSapling;
import tdwp_ftw.biomesop.blocks.BlockMangroveSlab;
import tdwp_ftw.biomesop.blocks.BlockMangroveStairs;
import tdwp_ftw.biomesop.blocks.BlockMediumGrass;
import tdwp_ftw.biomesop.blocks.BlockMoss;
import tdwp_ftw.biomesop.blocks.BlockMud;
import tdwp_ftw.biomesop.blocks.BlockMudBrick;
import tdwp_ftw.biomesop.blocks.BlockMudBrickSlab;
import tdwp_ftw.biomesop.blocks.BlockMudBrickStairs;
import tdwp_ftw.biomesop.blocks.BlockOrangeFlower;
import tdwp_ftw.biomesop.blocks.BlockOrangeLeaves;
import tdwp_ftw.biomesop.blocks.BlockOrangeSapling;
import tdwp_ftw.biomesop.blocks.BlockOriginGrass;
import tdwp_ftw.biomesop.blocks.BlockOriginLeaves;
import tdwp_ftw.biomesop.blocks.BlockOriginSapling;
import tdwp_ftw.biomesop.blocks.BlockPalmLeaves;
import tdwp_ftw.biomesop.blocks.BlockPalmLog;
import tdwp_ftw.biomesop.blocks.BlockPalmPlank;
import tdwp_ftw.biomesop.blocks.BlockPalmSapling;
import tdwp_ftw.biomesop.blocks.BlockPalmSlab;
import tdwp_ftw.biomesop.blocks.BlockPalmStairs;
import tdwp_ftw.biomesop.blocks.BlockPinkFlower;
import tdwp_ftw.biomesop.blocks.BlockPinkLeaves;
import tdwp_ftw.biomesop.blocks.BlockPinkSapling;
import tdwp_ftw.biomesop.blocks.BlockPromisedPortal;
import tdwp_ftw.biomesop.blocks.BlockPurpleFlower;
import tdwp_ftw.biomesop.blocks.BlockQuicksand;
import tdwp_ftw.biomesop.blocks.BlockRedLeaves;
import tdwp_ftw.biomesop.blocks.BlockRedRock;
import tdwp_ftw.biomesop.blocks.BlockRedRockCobble;
import tdwp_ftw.biomesop.blocks.BlockRedRockCobbleSlab;
import tdwp_ftw.biomesop.blocks.BlockRedRockCobbleStairs;
import tdwp_ftw.biomesop.blocks.BlockRedRockBrick;
import tdwp_ftw.biomesop.blocks.BlockRedRockBrickSlab;
import tdwp_ftw.biomesop.blocks.BlockRedRockBrickStairs;
import tdwp_ftw.biomesop.blocks.BlockRedSapling;
import tdwp_ftw.biomesop.blocks.BlockRedwoodLeaves;
import tdwp_ftw.biomesop.blocks.BlockRedwoodLog;
import tdwp_ftw.biomesop.blocks.BlockRedwoodPlank;
import tdwp_ftw.biomesop.blocks.BlockRedwoodSapling;
import tdwp_ftw.biomesop.blocks.BlockRedwoodSlab;
import tdwp_ftw.biomesop.blocks.BlockRedwoodStairs;
import tdwp_ftw.biomesop.blocks.BlockShortGrass;
import tdwp_ftw.biomesop.blocks.BlockSmolderingGrass;
import tdwp_ftw.biomesop.blocks.BlockSprout;
import tdwp_ftw.biomesop.blocks.BlockThorn;
import tdwp_ftw.biomesop.blocks.BlockTinyFlower;
import tdwp_ftw.biomesop.blocks.BlockTinyCactus;
import tdwp_ftw.biomesop.blocks.BlockToadstool;
import tdwp_ftw.biomesop.blocks.BlockTreeMoss;
import tdwp_ftw.biomesop.blocks.BlockWhiteFlower;
import tdwp_ftw.biomesop.blocks.BlockWhiteLeaves;
import tdwp_ftw.biomesop.blocks.BlockWhiteSapling;
import tdwp_ftw.biomesop.blocks.BlockWillow;
import tdwp_ftw.biomesop.blocks.BlockWillowLeaves;
import tdwp_ftw.biomesop.blocks.BlockWillowLog;
import tdwp_ftw.biomesop.blocks.BlockWillowPlank;
import tdwp_ftw.biomesop.blocks.BlockWillowSapling;
import tdwp_ftw.biomesop.blocks.BlockWillowSlab;
import tdwp_ftw.biomesop.blocks.BlockWillowStairs;
import tdwp_ftw.biomesop.blocks.BlockYellowSapling;
import tdwp_ftw.biomesop.blocks.BlockViolet;
...
import tdwp_ftw.biomesop.helpers.WorldGeneratorPromisedLandPortal;
...
@Mod(modid="BiomesOPlenty", name="Biomes O' Plenty", version="0.4.6")
...
{	    
        ...
        public void load(FMLInitializationEvent event)
        {
	    		...
	    		// Item declaration
	       		shroomPowder = (new ItemFood(shroomPowderID, 1, 0.5F, false)).setPotionEffect(Potion.confusion.id, 30, 0, 0.6F).setAlwaysEdible().setUnlocalizedName("shroomPowder").setCreativeTab(tabBiomesOPlenty);
	    		mudBall = (new Item(mudBallID)).setUnlocalizedName("mudBall").setCreativeTab(tabBiomesOPlenty);
	    		mudBrick = (new Item(mudBrickID)).setUnlocalizedName("mudBrick").setCreativeTab(tabBiomesOPlenty);
				...
				mossItem = (new Item(mossItemID)).setUnlocalizedName("mossItem").setCreativeTab(tabBiomesOPlenty);
	    		...
	    		ashes = (new Item(ashesID)).setUnlocalizedName("ashes").setCreativeTab(tabBiomesOPlenty);
				amethyst = (new Item(amethystID)).setUnlocalizedName("amethyst").setCreativeTab(tabBiomesOPlenty);
				ancientStaffHandle = (new Item(ancientStaffHandleID)).setUnlocalizedName("ancientStaffHandle").setCreativeTab(tabBiomesOPlenty);
				ancientStaffPole = (new Item(ancientStaffPoleID)).setUnlocalizedName("ancientStaffPole").setCreativeTab(tabBiomesOPlenty);
				ancientStaffTopper = (new Item(ancientStaffTopperID)).setUnlocalizedName("ancientStaffTopper").setCreativeTab(tabBiomesOPlenty);
	    		...
	    		swordMud = (new ItemSword(swordMudID, EnumToolMaterialMud)).setUnlocalizedName("swordMud").setCreativeTab(tabBiomesOPlenty);
	    		shovelMud = (new ItemSpade(shovelMudID, EnumToolMaterialMud)).setUnlocalizedName("shovelMud").setCreativeTab(tabBiomesOPlenty);
	    		pickaxeMud = (new ItemPickaxe(pickaxeMudID, EnumToolMaterialMud)).setUnlocalizedName("pickaxeMud").setCreativeTab(tabBiomesOPlenty);
	    		axeMud = (new ItemAxe(axeMudID, EnumToolMaterialMud)).setUnlocalizedName("hatchetMud").setCreativeTab(tabBiomesOPlenty);
	    		hoeMud = (new ItemHoe(hoeMudID, EnumToolMaterialMud)).setUnlocalizedName("hoeMud").setCreativeTab(tabBiomesOPlenty);
	    		...
	    		swordAmethyst = (new ItemSword(swordAmethystID, EnumToolMaterialAmethyst)).setUnlocalizedName("swordAmethyst").setCreativeTab(tabBiomesOPlenty);
	    		shovelAmethyst = (new ItemSpade(shovelAmethystID, EnumToolMaterialAmethyst)).setUnlocalizedName("shovelAmethyst").setCreativeTab(tabBiomesOPlenty);
	    		pickaxeAmethyst = (new ItemPickaxe(pickaxeAmethystID, EnumToolMaterialAmethyst)).setUnlocalizedName("pickaxeAmethyst").setCreativeTab(tabBiomesOPlenty);
	    		axeAmethyst = (new ItemAxe(axeAmethystID, EnumToolMaterialAmethyst)).setUnlocalizedName("hatchetAmethyst").setCreativeTab(tabBiomesOPlenty);
	    		hoeAmethyst = (new ItemHoe(hoeAmethystID, EnumToolMaterialAmethyst)).setUnlocalizedName("hoeAmethyst").setCreativeTab(tabBiomesOPlenty);
