...
public class BOPConfiguration {
	...
	public static void init(File configFile) 
	{
		...
		try 
		{
			...
			alpsID = config.get("Biome IDs", "Alps ID", 176).getInt();
			arcticID = config.get("Biome IDs", "Arctic ID", 177).getInt();
			badlandsID = config.get("Biome IDs", "Badlands ID", 178).getInt();
			bambooForestID = config.get("Biome IDs", "Bamboo Forest ID", 179).getInt();
			bayouID = config.get("Biome IDs", "Bayou ID", 180).getInt();
			birchForestID = config.get("Biome IDs", "Birch Forest ID", 181).getInt();
			bogID = config.get("Biome IDs", "Bog ID", 182).getInt();
			borealForestID = config.get("Biome IDs", "Boreal Forest ID", 183).getInt();
			canyonID = config.get("Biome IDs", "Canyon ID", 184).getInt();
			chaparralID = config.get("Biome IDs", "Chaparral ID", 185).getInt();
			cherryBlossomGroveID = config.get("Biome IDs", "Cherry Blossom Grove ID", 186).getInt();
			coniferousForestID = config.get("Biome IDs", "Coniferous Forest ID", 187).getInt();
			cragID = config.get("Biome IDs", "Crag ID", 188).getInt();
			deadForestID = config.get("Biome IDs", "Dead Forest ID", 189).getInt();
			deadSwampID = config.get("Biome IDs", "Dead Swamp ID", 190).getInt();
			deadlandsID = config.get("Biome IDs", "Deadlands ID", 191).getInt();
			deciduousForestID = config.get("Biome IDs", "Deciduous Forest ID", 192).getInt();
			drylandsID = config.get("Biome IDs", "Drylands ID", 193).getInt();
			dunesID = config.get("Biome IDs", "Dunes ID", 194).getInt();
			fenID = config.get("Biome IDs", "Fen ID", 195).getInt();
			fieldID = config.get("Biome IDs", "Field ID", 196).getInt();
			frostForestID = config.get("Biome IDs", "Frost Forest ID", 197).getInt();
			fungiForestID = config.get("Biome IDs", "Fungi Forest ID", 198).getInt();
			gardenID = config.get("Biome IDs", "Garden ID", 199).getInt();
			glacierID = config.get("Biome IDs", "Glacier ID", 200).getInt();
			grasslandID = config.get("Biome IDs", "Grassland ID", 201).getInt();
			groveID = config.get("Biome IDs", "Grove ID", 202).getInt();
			heathlandID = config.get("Biome IDs", "Heathland ID", 203).getInt();
			highlandID = config.get("Biome IDs", "Highland ID", 204).getInt();
			iceSheetID = config.get("Biome IDs", "Ice Sheet ID", 205).getInt();
			icyHillsID = config.get("Biome IDs", "Icy Hills ID", 206).getInt();
			jadeCliffsID = config.get("Biome IDs", "Jade Cliffs ID", 207).getInt();
			lushDesertID = config.get("Biome IDs", "Lush Desert ID", 208).getInt();
			lushSwampID = config.get("Biome IDs", "Lush Swamp ID", 209).getInt();
