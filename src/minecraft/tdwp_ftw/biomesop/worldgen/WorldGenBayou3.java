        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 128)
        {
            ...
            else
            {
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 128 - var6 - 1)
                {
                    ...
                    this.setBlock(par1World, par3, par4 + 3, par5 + 1, mod_BiomesOPlenty.willowWood.blockID);
                    this.setBlock(par1World, par3 - 1, par4 + 4, par5, mod_BiomesOPlenty.willowWood.blockID);
                    this.setBlock(par1World, par3 + 1, par4 + 4, par5, mod_BiomesOPlenty.willowWood.blockID);
                    this.setBlock(par1World, par3, par4 + 4, par5 - 1, mod_BiomesOPlenty.willowWood.blockID);
                    this.setBlock(par1World, par3, par4 + 4, par5 + 1, mod_BiomesOPlenty.willowWood.blockID);
                    int var13;
                    int var16;
