...
public class WorldGenDarkTreeOld1 extends WorldGenerator
{
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
		...
		if (var96 != Block.grass.blockID)
        {
            return false;
        }
		if (var97 != Block.grass.blockID)
        {
            return false;
        }
		if (var98 != Block.grass.blockID)
        {
            return false;
        }
		if (var99 != Block.grass.blockID)
        {
            return false;
        }
        else
