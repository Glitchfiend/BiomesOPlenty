    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
                ...
                for (var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
                {
                    for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var12 != 0 && var12 != mod_BiomesOPlenty.originLeaves.blockID)
                            {
                                var7 = false;
                            }
                        }
            ...
            else
            {
                ...
                if ((var8 == mod_BiomesOPlenty.originGrass.blockID || var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var16 = par4 - 3 + var6; var16 <= par4 + var6; ++var16)
                    {
                        ...
                        for (var12 = par3 - var11; var12 <= par3 + var11; ++var12)
                        {
                            ...
                            for (int var14 = par5 - var11; var14 <= par5 + var11; ++var14)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var12, var16, var14, mod_BiomesOPlenty.originLeaves.blockID, 0);
                                }
                            }
                        }
                    }
                    ...
                    for (var16 = 0; var16 < var6; ++var16)
                    {
                        ...
                        if (var10 == 0 || var10 == mod_BiomesOPlenty.originLeaves.blockID)
                        {
