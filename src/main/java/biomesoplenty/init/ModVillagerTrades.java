...
public class ModVillagerTrades
{
    ...
    public static void addWanderingVillagerTrades(WandererTradesEvent event)
    {
        ...
        VillagerTrades.ItemListing[] WANDERING_TRADER_GENERIC = new VillagerTrades.ItemListing[]{
            ...
            new ItemsForEmeralds(BOPBlocks.RED_MAPLE_SAPLING.get(), 5, 1, 8, 1),
            new ItemsForEmeralds(BOPBlocks.ORANGE_MAPLE_SAPLING.get(), 5, 1, 8, 1),
            new ItemsForEmeralds(BOPBlocks.YELLOW_MAPLE_SAPLING.get(), 5, 1, 8, 1),
