...
public class ModBlocks
{
    public static void registerBlocks()
    {
        ...
        if (FabricLoader.getInstance().getEnvironmentType() == EnvType.CLIENT)
        {
            ...
            BlockRenderLayerMap.INSTANCE.putBlock(TREE_ROOTS, cutoutRenderType);
            BlockRenderLayerMap.INSTANCE.putBlock(TREE_ROOTS_STEM, cutoutRenderType);
            BlockRenderLayerMap.INSTANCE.putBlock(GLOWWORM_SILK, cutoutRenderType);
            BlockRenderLayerMap.INSTANCE.putBlock(GLOWWORM_SILK_STRAND, cutoutRenderType);
            BlockRenderLayerMap.INSTANCE.putBlock(HANGING_COBWEB, cutoutRenderType);
            BlockRenderLayerMap.INSTANCE.putBlock(HANGING_COBWEB_STRAND, cutoutRenderType);
