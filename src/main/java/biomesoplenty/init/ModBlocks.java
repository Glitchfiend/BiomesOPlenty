...
public class ModBlocks
{
    public static void init()
    {
    	...
    	loamy_dirt = registerBlock(new Block(Block.Builder.create(Material.GROUND, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(0.5F).sound(SoundType.GROUND)), "loamy_dirt");
    	coarse_loamy_dirt = registerBlock(new Block(Block.Builder.create(Material.GROUND, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(0.5F).sound(SoundType.GROUND)), "coarse_loamy_dirt");
    	...
    	loamy_farmland = registerBlock(new BlockFarmland(Block.Builder.create(Material.GROUND, MapColor.GRAY_TERRACOTTA).needsRandomTick().hardnessAndResistance(0.6F).sound(SoundType.GROUND)), "loamy_farmland");
    	...
    	sandy_dirt = registerBlock(new Block(Block.Builder.create(Material.GROUND, MapColor.WOOD).hardnessAndResistance(0.5F).sound(SoundType.GROUND)), "sandy_dirt");
    	coarse_sandy_dirt = registerBlock(new Block(Block.Builder.create(Material.GROUND, MapColor.WOOD).hardnessAndResistance(0.5F).sound(SoundType.GROUND)), "coarse_sandy_dirt");
    	...
    	sandy_farmland = registerBlock(new BlockFarmland(Block.Builder.create(Material.GROUND, MapColor.WOOD).needsRandomTick().hardnessAndResistance(0.6F).sound(SoundType.GROUND)), "sandy_farmland");
    	...
    	silty_dirt = registerBlock(new Block(Block.Builder.create(Material.GROUND, MapColor.LIGHT_GRAY_TERRACOTTA).hardnessAndResistance(0.5F).sound(SoundType.GROUND)), "silty_dirt");
    	coarse_silty_dirt = registerBlock(new Block(Block.Builder.create(Material.GROUND, MapColor.LIGHT_GRAY_TERRACOTTA).hardnessAndResistance(0.5F).sound(SoundType.GROUND)), "coarse_silty_dirt");
    	...
    	silty_farmland = registerBlock(new BlockFarmland(Block.Builder.create(Material.GROUND, MapColor.LIGHT_GRAY_TERRACOTTA).needsRandomTick().hardnessAndResistance(0.6F).sound(SoundType.GROUND)), "silty_farmland");
        ...
        mud = registerBlock(new BlockMud(Builder.create(Material.GROUND, MapColor.BROWN_TERRACOTTA).hardnessAndResistance(0.6F)), "mud");
        ...
        dried_sand = registerBlock(new Block(Builder.create(Material.GROUND, MapColor.WOOD).hardnessAndResistance(1.0F)), "dried_sand");
        ash_block = registerBlock(new BlockAsh(Builder.create(Material.SAND, MapColor.BLACK_TERRACOTTA).hardnessAndResistance(0.4F).sound(SoundType.SAND)), "ash_block");
        flesh = registerBlock(new BlockFlesh(Builder.create(Material.SPONGE, MapColor.RED_TERRACOTTA).hardnessAndResistance(0.4F).sound(SoundType.SLIME)), "flesh");
        ...
        orange_autumn_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "orange_autumn_leaves");
        ...
        fir_log = registerBlock(new BlockLog(MapColor.WHITE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.LIGHT_GRAY_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "fir_log");
        fir_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "fir_wood");
        stripped_fir_log = registerBlock(new BlockLog(MapColor.WHITE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_fir_log");
        stripped_fir_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_fir_wood");
        fir_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "fir_planks");
        fir_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "fir_slab");
        ...
        fir_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "fir_trapdoor");
        ...
        redwood_log = registerBlock(new BlockLog(MapColor.ORANGE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "redwood_log");
        redwood_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "redwood_wood");
        stripped_redwood_log = registerBlock(new BlockLog(MapColor.ORANGE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_redwood_log");
        stripped_redwood_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_redwood_wood");
        redwood_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "redwood_planks");
        redwood_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "redwood_slab");
        ...
        redwood_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.ORANGE_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "redwood_trapdoor");
        ...
        white_cherry_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.SNOW).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "white_cherry_leaves");
        ...
        pink_cherry_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.PINK).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "pink_cherry_leaves");
        cherry_log = registerBlock(new BlockLog(MapColor.RED, Block.Builder.create(Material.WOOD, MapColor.RED_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "cherry_log");
        cherry_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.RED).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "cherry_wood");
        stripped_cherry_log = registerBlock(new BlockLog(MapColor.RED, Block.Builder.create(Material.WOOD, MapColor.RED).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_cherry_log");
        stripped_cherry_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.RED).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_cherry_wood");
        cherry_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.RED).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "cherry_planks");
        cherry_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.RED).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "cherry_slab");
        ...
        cherry_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.RED).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "cherry_trapdoor");
        ...
        mahogany_log = registerBlock(new BlockLog(MapColor.PINK_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.DIRT).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "mahogany_log");
        mahogany_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.PINK_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "mahogany_wood");
        stripped_mahogany_log = registerBlock(new BlockLog(MapColor.PINK_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.PINK_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_mahogany_log");
        stripped_mahogany_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.PINK_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_mahogany_wood");
        mahogany_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.PINK_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "mahogany_planks");
        mahogany_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.PINK_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "mahogany_slab");
        ...
        mahogany_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.PINK_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "mahogany_trapdoor");
        ...
        jacaranda_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.PURPLE).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "jacaranda_leaves");
        jacaranda_log = registerBlock(new BlockLog(MapColor.WHITE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.LIGHT_GRAY_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "jacaranda_log");
        jacaranda_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "jacaranda_wood");
        stripped_jacaranda_log = registerBlock(new BlockLog(MapColor.WHITE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_jacaranda_log");
        stripped_jacaranda_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_jacaranda_wood");
        jacaranda_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "jacaranda_planks");
        jacaranda_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "jacaranda_slab");
        ...
        jacaranda_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "jacaranda_trapdoor");
        ...
        palm_log = registerBlock(new BlockLog(MapColor.YELLOW_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "palm_log");
        palm_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "palm_wood");
        stripped_palm_log = registerBlock(new BlockLog(MapColor.YELLOW_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_palm_log");
        stripped_palm_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_palm_wood");
        palm_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "palm_planks");
        palm_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "palm_slab");
        ...
        palm_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "palm_trapdoor");
        ...
        willow_log = registerBlock(new BlockLog(MapColor.LIME_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "willow_log");
        willow_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "willow_wood");
        stripped_willow_log = registerBlock(new BlockLog(MapColor.LIME_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_willow_log");
        stripped_willow_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_willow_wood");
        willow_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "willow_planks");
        willow_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "willow_slab");
        ...
        willow_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "willow_trapdoor");
        ...
        dead_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.WOOD).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "dead_leaves");
        dead_log = registerBlock(new BlockLog(MapColor.STONE, Block.Builder.create(Material.WOOD, MapColor.GRAY).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "dead_log");
        dead_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.STONE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "dead_wood");
        ...
        stripped_dead_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.STONE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_dead_wood");
        dead_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.STONE).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "dead_planks");
        dead_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.STONE).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "dead_slab");
        ...
        dead_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.STONE).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "dead_trapdoor");
        ...
        magic_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.CYAN).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "magic_leaves");
        magic_log = registerBlock(new BlockLog(MapColor.BLUE, Block.Builder.create(Material.WOOD, MapColor.LIGHT_BLUE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "magic_log");
        magic_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.BLUE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "magic_wood");
        stripped_magic_log = registerBlock(new BlockLog(MapColor.BLUE, Block.Builder.create(Material.WOOD, MapColor.BLUE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_magic_log");
        stripped_magic_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.BLUE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_magic_wood");
        magic_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.BLUE).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "magic_planks");
        magic_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.BLUE).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "magic_slab");
        ...
        magic_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.BLUE).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "magic_trapdoor");
        ...
        umbran_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "umbran_leaves");
        umbran_log = registerBlock(new BlockLog(MapColor.BLUE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "umbran_log");
        umbran_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "umbran_wood");
        stripped_umbran_log = registerBlock(new BlockLog(MapColor.BLUE_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_umbran_log");
        stripped_umbran_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_umbran_wood");
        umbran_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "umbran_planks");
        umbran_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "umbran_slab");
        ...
        umbran_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "umbran_trapdoor");
        ...
        hellbark_leaves = registerBlock(new BlockLeavesBOP(Block.Builder.create(Material.LEAVES, MapColor.PURPLE_TERRACOTTA).hardnessAndResistance(0.2F).needsRandomTick().sound(SoundType.PLANT)), "hellbark_leaves");
        hellbark_log = registerBlock(new BlockLog(MapColor.GRAY_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.LIGHT_GRAY).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "hellbark_log");
        hellbark_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "hellbark_wood");
        stripped_hellbark_log = registerBlock(new BlockLog(MapColor.GRAY_TERRACOTTA, Block.Builder.create(Material.WOOD, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_hellbark_log");
        stripped_hellbark_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_hellbark_wood");
        hellbark_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "hellbark_planks");
        hellbark_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "hellbark_slab");
        ...
        hellbark_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.GRAY_TERRACOTTA).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "hellbark_trapdoor");
        ...
        ethereal_log = registerBlock(new BlockLog(MapColor.CYAN, Block.Builder.create(Material.WOOD, MapColor.LIME_TERRACOTTA).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "ethereal_log");
        ethereal_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.CYAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "ethereal_wood");
        stripped_ethereal_log = registerBlock(new BlockLog(MapColor.CYAN, Block.Builder.create(Material.WOOD, MapColor.CYAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_ethereal_log");
        stripped_ethereal_wood = registerBlock(new BlockRotatedPillar(Block.Builder.create(Material.WOOD, MapColor.CYAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)), "stripped_ethereal_wood");
        ethereal_planks = registerBlock(new Block(Builder.create(Material.WOOD, MapColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "ethereal_planks");
        ethereal_slab = registerBlock(new BlockSlab(Block.Builder.create(Material.WOOD, MapColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)), "ethereal_slab");
        ...
        ethereal_trapdoor = registerBlock(new BlockTrapDoor(Block.Builder.create(Material.WOOD, MapColor.CYAN).hardnessAndResistance(3.0F).sound(SoundType.WOOD)), "ethereal_trapdoor");
        ...
        lavender = registerBlock(new BlockFlowerBOP(Block.Builder.create(Material.PLANTS, MapColor.MAGENTA).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "lavender");
        goldenrod = registerBlock(new BlockFlowerBOP(Block.Builder.create(Material.PLANTS, MapColor.YELLOW_TERRACOTTA).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "goldenrod");
        ...
        barley = registerBlock(new BlockFoliageBOP(Block.Builder.create(Material.VINE, MapColor.YELLOW_TERRACOTTA).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "barley");
        dune_grass = registerBlock(new BlockFoliageBOP(Block.Builder.create(Material.VINE, MapColor.LIME_TERRACOTTA).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "dune_grass");
        desert_grass = registerBlock(new BlockFoliageBOP(Block.Builder.create(Material.VINE, MapColor.ORANGE_TERRACOTTA).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "desert_grass");
        dead_grass = registerBlock(new BlockFoliageBOP(Block.Builder.create(Material.VINE, MapColor.WOOD).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "dead_grass");
        ...
        spectral_fern = registerBlock(new BlockFoliageBOP(Block.Builder.create(Material.VINE, MapColor.RED).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "spectral_fern");
        
        thorn = registerBlock(new BlockPlantBOP(Block.Builder.create(Material.PLANTS, MapColor.LIGHT_GRAY_TERRACOTTA).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "thorn");
        ...
        cattail = registerBlock(new BlockPlantBOP(Block.Builder.create(Material.PLANTS, MapColor.DIRT).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "cattail");
        tall_cattail = registerBlock(new BlockDoublePlantBOP(cattail, Block.Builder.create(Material.PLANTS, MapColor.DIRT).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "tall_cattail");
        ...
        reed = registerBlock(new BlockPlantBOP(Block.Builder.create(Material.PLANTS, MapColor.DIRT).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)), "reed");
        ...
        bramble = registerBlock(new BlockBramble(Block.Builder.create(Material.PLANTS, MapColor.NETHERRACK).hardnessAndResistance(0.4F).sound(SoundType.WOOD)), "bramble");
