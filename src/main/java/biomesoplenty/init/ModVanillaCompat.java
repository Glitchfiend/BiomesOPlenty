...
public class ModVanillaCompat
{
    public static void setup()
    {
        ...
        registerFlammable(BOPBlocks.RED_MAPLE_LEAVES.get(), 30, 60);
        registerFlammable(BOPBlocks.ORANGE_MAPLE_LEAVES.get(), 30, 60);
        registerFlammable(BOPBlocks.YELLOW_MAPLE_LEAVES.get(), 30, 60);
        registerFlammable(BOPBlocks.MAPLE_LOG.get(), 5, 5);
        registerFlammable(BOPBlocks.MAPLE_WOOD.get(), 5, 5);
        registerFlammable(BOPBlocks.STRIPPED_MAPLE_LOG.get(), 5, 5);
        registerFlammable(BOPBlocks.STRIPPED_MAPLE_WOOD.get(), 5, 5);
        registerFlammable(BOPBlocks.MAPLE_PLANKS.get(), 5, 20);
        registerFlammable(BOPBlocks.MAPLE_SLAB.get(), 5, 20);
        registerFlammable(BOPBlocks.MAPLE_STAIRS.get(), 5, 20);
        registerFlammable(BOPBlocks.MAPLE_FENCE.get(), 5, 20);
        registerFlammable(BOPBlocks.MAPLE_FENCE_GATE.get(), 5, 20);
        ...
        registerStrippable(BOPBlocks.MAPLE_LOG.get(), BOPBlocks.STRIPPED_MAPLE_LOG.get());
        registerStrippable(BOPBlocks.MAPLE_WOOD.get(), BOPBlocks.STRIPPED_MAPLE_WOOD.get());
        ...
        registerCompostable(0.3F, BOPBlocks.RED_MAPLE_SAPLING.get());
        registerCompostable(0.3F, BOPBlocks.RED_MAPLE_LEAVES.get());
        registerCompostable(0.3F, BOPBlocks.ORANGE_MAPLE_SAPLING.get());
        registerCompostable(0.3F, BOPBlocks.ORANGE_MAPLE_LEAVES.get());
        registerCompostable(0.3F, BOPBlocks.YELLOW_MAPLE_SAPLING.get());
        registerCompostable(0.3F, BOPBlocks.YELLOW_MAPLE_LEAVES.get());
