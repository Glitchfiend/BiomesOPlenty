...
import biomesoplenty.blocks.BlockBeetroot;
...
import biomesoplenty.itemblocks.ItemBlockBeetroot;
...
public class BOPBlocks 
{
	...
	private static void initializeBlocks()
	{
		...
		Blocks.beetroot = Optional.of((new BlockBeetroot(BOPConfigurationIDs.beetrootID)).setUnlocalizedName("bop.beetroot").setTextureName("beetroot"));
	...
	private static void registerBlocks()
	{
		...
		registerBlock(Blocks.beetroot.get());
