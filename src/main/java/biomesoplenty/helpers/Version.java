...
import biomesoplenty.lib.Reference;
...
public class Version implements Runnable {
	...
	public static void versionCheck() 
	{
		try {
			...
			if ("0.0.0".equals(Reference.VERSION))
				return;
			...
			FMLCommonHandler.instance().getFMLLogger().log(Level.WARNING,"[BiomesOPlenty] Using outdated version [" + Reference.VERSION + "] for Minecraft " + mcVersion + ". Consider updating.");
