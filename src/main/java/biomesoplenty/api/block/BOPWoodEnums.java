...
public class BOPWoodEnums
{
    ...
    public static enum AllWoods implements IStringSerializable, IPagedVariants
    {
        ...
        public static Predicate withPlanks = new Predicate<AllWoods>()
        {
            @Override
            public boolean apply(AllWoods wood) {return wood.hasPlanks();}
        };
    }
