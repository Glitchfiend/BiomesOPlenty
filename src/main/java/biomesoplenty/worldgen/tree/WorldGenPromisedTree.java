	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		if (par4 >= 1 && par4 + var6 + 1 <= 256)
		{
			...
			else
			{
				...
				if ((var11 == BOPBlocks.holyGrass.get().blockID || var11 == BOPBlocks.holyDirt.get().blockID) && par4 < 256 - var6 - 1)
				{
					this.setBlockAndMetadata(par1World, par3, par4 - 1, par5, BOPBlocks.holyDirt.get().blockID, 0);
					...
					for (var15 = 0; var15 <= var8; ++var15)
					{
						...
						for (var17 = par3 - var21; var17 <= par3 + var21; ++var17)
						{
							...
							for (int var19 = par5 - var21; var19 <= par5 + var21; ++var19)
							{
								...
								{
									this.setBlockAndMetadata(par1World, var17, var16, var19, BOPBlocks.leaves2.get().blockID, 2);
								}
							}
						}
					...
					for (var16 = 0; var16 < var6 - var15; ++var16)
					{
						...
						if (var17 == 0 || var17 == BOPBlocks.leaves2.get().blockID)
						{
							this.setBlockAndMetadata(par1World, par3, par4 + var16, par5, BOPBlocks.logs2.get().blockID,0);
						}
					}
