									...
									for (var18 = 0; var18 <= var8; ++var18)
									{
										...
										for (var20 = var3 - var15; var20 <= var3 + var15; ++var20)
										{
											...
											for (int var22 = var5 - var15; var22 <= var5 + var15; ++var22)
											{
												...
												{
													this.setBlockAndMetadata(var1, var20, var19, var22, BOPBlocks.leaves1.get().blockID, 0);
													this.setBlockAndMetadata(var1, var20 + 1, var19, var22, BOPBlocks.leaves1.get().blockID, 0);
													this.setBlockAndMetadata(var1, var20 - 1, var19, var22, BOPBlocks.leaves1.get().blockID, 0);
													this.setBlockAndMetadata(var1, var20, var19, var22 + 1, BOPBlocks.leaves1.get().blockID, 0);
													this.setBlockAndMetadata(var1, var20, var19, var22 - 1, BOPBlocks.leaves1.get().blockID, 0);
