			...
			else
			{
				...
				if ((var11 == Block.grass.blockID || var11 == Block.dirt.blockID) && var4 < 256 - var6 - 1)
				{
					...
					for (var15 = 0; var15 <= var8; ++var15)
					{
						...
						for (var17 = var3 - var21; var17 <= var3 + var21; ++var17)
						{
							...
							for (int var19 = var5 - var21; var19 <= var5 + var21; ++var19)
							{
								...
								{
									this.setBlockAndMetadata(var1, var17, var16, var19, BOPBlocks.leaves2.get().blockID, 1);
								}
							}
						}
					...
					for (var16 = 0; var16 < var6 - var15; ++var16)
					{
						...
						{
							this.setBlockAndMetadata(var1, var3, var4 + var16, var5, BOPBlocks.logs1.get().blockID, 3);
						}
					}
