...
public class WorldGenCobwebs extends WorldGenerator
{
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		for (int l = 0; l < 64; ++l)
		{
			...
			if (par1World.isAirBlock(i1, j1, k1) && (par1World.getBlockId(i1, j1 + 1, k1) == BOPBlocks.leaves2.get().blockID || par1World.getBlockId(i1, j1 + 1, k1) == BOPBlocks.leavesColorized2.get().blockID || par1World.getBlockId(i1, j1 - 1, k1) == Block.grass.blockID))
			{
