...
public class WorldGenWasteland2 extends WorldGenerator
{
	@Override
	public boolean generate(World var1, Random var2, int var3, int var4, int var5)
	{
		...
		else
		{
			...
			var1.setBlock(var3 - 2, var4 + 2, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 2, var4 + 2, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 2, var4 + 2, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 2, var4 + 2, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 2, var4 + 2, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 2, var4 + 2, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 1, var4 + 2, var5 - 2, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 2, var5 - 2, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 2, var5 - 2, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 1, var4 + 2, var5 + 2, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 2, var5 + 2, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 2, var5 + 2, BOPBlocks.driedDirt.get().blockID);
			...
			var1.setBlock(var3, var4 + 4, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 1, var4 + 4, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 4, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 1, var4 + 4, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 4, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			...
			var1.setBlock(var3, var4 + 5, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 1, var4 + 5, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 5, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 - 1, var4 + 5, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 5, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			...
			var1.setBlock(var3 - 1, var4 + 6, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 6, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 6, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 6, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			
			var1.setBlock(var3, var4 + 6, var5, BOPBlocks.driedDirt.get().blockID);
			
			var1.setBlock(var3 - 1, var4 + 7, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 7, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 7, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 7, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			
			var1.setBlock(var3, var4 + 7, var5, BOPBlocks.driedDirt.get().blockID);
			
			var1.setBlock(var3 - 1, var4 + 8, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3 + 1, var4 + 8, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 8, var5 - 1, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 8, var5 + 1, BOPBlocks.driedDirt.get().blockID);
			
			var1.setBlock(var3, var4 + 8, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 9, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 10, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 11, var5, BOPBlocks.driedDirt.get().blockID);
			var1.setBlock(var3, var4 + 12, var5, BOPBlocks.driedDirt.get().blockID);
