...
public class OrangeAutumnLeavesBlock extends LeavesBlock
{
    public OrangeAutumnLeavesBlock(Properties p_273704_)
    {
        super(p_273704_);
    }
    ...
    public void animateTick(BlockState p_272714_, Level p_272837_, BlockPos p_273218_, RandomSource p_273360_)
    {
        ...
        if (p_273360_.nextInt(25) == 0)
        {
            ...
            {
                ParticleUtils.spawnParticleBelow(p_272837_, p_273218_, p_273360_, ModParticles.ORANGE_AUTUMN_LEAVES.get());
            }
        }
    }
}