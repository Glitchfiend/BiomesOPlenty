...
public class RootedSandBlock extends Block implements BonemealableBlock
{
    ...
    @Override
    public boolean isBonemealSuccess(Level p_154371_, RandomSource p_154372_, BlockPos p_154373_, BlockState p_154374_) {
        return true;
    }

    @Override
    public void performBonemeal(ServerLevel p_154361_, RandomSource p_154362_, BlockPos p_154363_, BlockState p_154364_) {
