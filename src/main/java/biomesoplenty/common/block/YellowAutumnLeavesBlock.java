...
public class YellowAutumnLeavesBlock extends LeavesBlock
{
    public YellowAutumnLeavesBlock(Properties p_273704_)
    {
        super(p_273704_);
    }
    ...
    public void animateTick(BlockState p_272714_, Level p_272837_, BlockPos p_273218_, RandomSource p_273360_)
    {
        ...
        if (p_273360_.nextInt(35) == 0)
        {
            ...
            {
                ParticleUtils.spawnParticleBelow(p_272837_, p_273218_, p_273360_, ModParticles.YELLOW_AUTUMN_LEAVES.get());
            }
        }
    }
}