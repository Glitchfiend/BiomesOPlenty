...
public class FernGrassFeature extends Feature<NoneFeatureConfiguration>
{
	public FernGrassFeature(Codec<NoneFeatureConfiguration> deserializer)
	{
		super(deserializer);
	}
	...
	{
		return rand.nextInt(3) == 0 ? Blocks.FERN.defaultBlockState() : Blocks.GRASS.defaultBlockState();
	}
