...
public class OrangeSandstoneSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public OrangeSandstoneSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> p_i232124_1_) {
        super(p_i232124_1_);
    }
