...
public class BlackSandSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public BlackSandSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> p_i232124_1_) {
        super(p_i232124_1_);
    }
