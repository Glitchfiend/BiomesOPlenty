...
public class HighlandCragSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration>
{
	public HighlandCragSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> deserializer)
	{
		super(deserializer);
	}
