...
public class DeepTopLayerSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public DeepTopLayerSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> p_i51315_1_) {
        super(p_i51315_1_);
    }
