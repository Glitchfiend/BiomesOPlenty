...
//        registry.register(LevelStem.NETHER, new LevelStem(() -> DEFAULT_NETHER, /* ModConfig.GenerationConfig.useBopNether.get() */ true ? bopNetherGenerator(biomeRegistry, dimensionSettingsRegistry, seed) : DimensionType.defaultNetherGenerator(biomeRegistry, dimensionSettingsRegistry, seed)), Lifecycle.stable());
