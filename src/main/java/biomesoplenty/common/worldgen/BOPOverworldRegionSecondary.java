...
import biomesoplenty.common.biome.BOPSecondaryOverworldBiomeBuilder;
...
{
    public static final ResourceLocation LOCATION = new ResourceLocation(BiomesOPlenty.MOD_ID, "overworld_secondary");
