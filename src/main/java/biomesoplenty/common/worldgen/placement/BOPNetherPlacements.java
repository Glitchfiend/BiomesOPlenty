...
public class BOPNetherPlacements
{
    ...
    public static final RegistryObject<PlacedFeature> HAIR = register("hair", BOPNetherFeatures.HAIR, () -> List.of(CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> PUS_BUBBLES = register("pus_bubbles", BOPNetherFeatures.PUS_BUBBLES, () -> List.of(CountPlacement.of(15), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()));
