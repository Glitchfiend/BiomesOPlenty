...
public class BOPNetherPlacements
{
    ...
    public static final PlacedFeature LARGE_ROSE_QUARTZ = register("large_rose_quartz", BOPNetherFeatures.LARGE_ROSE_QUARTZ.placed(CountPlacement.of(7), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    ...
    public static final PlacedFeature SMALL_CRYSTAL = register("small_crystal", BOPNetherFeatures.SMALL_CRYSTAL.placed(CountPlacement.of(100), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
