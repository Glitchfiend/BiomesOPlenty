...
public class BOPNetherPlacements
{
    ...
    public static final PlacedFeature LARGE_FUMAROLE = register("large_fumarole", BOPNetherFeatures.LARGE_FUMAROLE.placed(CountPlacement.of(200), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    ...
    public static final PlacedFeature SMALL_FUMAROLE = register("small_fumarole", BOPNetherFeatures.SMALL_FUMAROLE.placed(CountPlacement.of(100), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
