...
public class BOPNetherPlacements
{
    ...
    public static final RegistryObject<PlacedFeature> BLACKSTONE_SPINES = register("blackstone_spines", BOPNetherFeatures.BLACKSTONE_SPINES, () -> List.of(CountPlacement.of(120), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> BRIMSTONE_BUD = register("brimstone_bud", BOPNetherFeatures.BRIMSTONE_BUD, () -> List.of(CountPlacement.of(200), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    public static final RegistryObject<PlacedFeature> BRIMSTONE_CLUSTER = register("brimstone_cluster", BOPNetherFeatures.BRIMSTONE_CLUSTER, () -> List.of(CountPlacement.of(22), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> HAIR = register("hair", BOPNetherFeatures.HAIR, () -> List.of(CountPlacement.of(30), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    public static final RegistryObject<PlacedFeature> HANGING_FLESH_TENDONS = register("hanging_flesh_tendons", BOPNetherFeatures.HANGING_FLESH_TENDON, () -> List.of(CountPlacement.of(100), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    public static final RegistryObject<PlacedFeature> INFERNO_DELTA = register("inferno_delta", BOPNetherFeatures.INFERNO_DELTA, () -> List.of(CountOnEveryLayerPlacement.of(6), BiomeFilter.biome()));
    public static final RegistryObject<PlacedFeature> INFERNO_LAVA_SPRING = register("inferno_lava_spring", BOPNetherFeatures.INFERNO_LAVA_SPRING, () -> List.of(CountPlacement.of(24), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()));
    public static final RegistryObject<PlacedFeature> INFERNO_SPLATTER = register("inferno_splatter", BOPNetherFeatures.INFERNO_SPLATTER, () -> List.of(CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    public static final RegistryObject<PlacedFeature> LARGE_FUMAROLE = register("large_fumarole", BOPNetherFeatures.LARGE_FUMAROLE, () -> List.of(CountPlacement.of(175), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> PUS_BUBBLES = register("pus_bubbles", BOPNetherFeatures.PUS_BUBBLES, () -> List.of(CountPlacement.of(18), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> SMALL_FUMAROLE = register("small_fumarole", BOPNetherFeatures.SMALL_FUMAROLE, () -> List.of(CountPlacement.of(80), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
