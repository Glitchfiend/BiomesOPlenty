...
public class BOPTreePlacements
{
    ...
    public static final PlacedFeature DEAD_TWIGLET_TREE_SMALL_CHECKED = register("dead_twiglet_tree_small", BOPTreeFeatures.DEAD_TWIGLET_TREE_SMALL.filteredByBlockSurvival(BOPBlocks.DEAD_SAPLING));
    ...
    public static final PlacedFeature TWIGLET_TREE_VOLCANO_CHECKED = register("twiglet_tree_volcano", BOPTreeFeatures.TWIGLET_TREE_VOLCANO.filtered(BlockPredicate.matchesBlock(BOPBlocks.BLACK_SAND, new BlockPos(0, -1, 0))));
