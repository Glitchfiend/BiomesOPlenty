...
public class BOPMiscOverworldPlacements
{
    ...
    public static final ResourceKey<PlacedFeature> DISK_WHITE_SANDSTONE = createKey("disk_white_sandstone");
    ...
    public static final ResourceKey<PlacedFeature> DISK_HOT_SPRING_PACKED_MUD = createKey("disk_hot_spring_packed_mud");
    public static final ResourceKey<PlacedFeature> DISK_HOT_SPRING_THERMAL_CALCITE = createKey("disk_hot_spring_thermal_calcite");

    public static final ResourceKey<PlacedFeature> DISK_VOLCANO_SMOOTH_BASALT = createKey("disk_volcano_smooth_basalt");
    public static final ResourceKey<PlacedFeature> DISK_VOLCANO_BLACK_SANDSTONE = createKey("disk_volcano_black_sandstone");
    public static final ResourceKey<PlacedFeature> DISK_VOLCANO_MAGMA = createKey("disk_volcano_magma");
    ...
    public static final ResourceKey<PlacedFeature> LAKE_HOT_SPRING = createKey("lake_hot_spring");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context)
    {
        ...
        register(context, BOPMiscOverworldPlacements.DISK_WHITE_SAND_EXTRA, DISK_WHITE_SAND_EXTRA, List.of(CountPlacement.of(75), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.matchesFluids(Fluids.WATER)), BiomeFilter.biome()));
        register(context, BOPMiscOverworldPlacements.DISK_WHITE_SANDSTONE, DISK_WHITE_SANDSTONE, List.of(CountPlacement.of(75), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.matchesFluids(Fluids.WATER)), BiomeFilter.biome()));
