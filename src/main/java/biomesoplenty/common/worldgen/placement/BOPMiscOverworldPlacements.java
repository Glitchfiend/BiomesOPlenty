...
public class BOPMiscOverworldPlacements
{
    ...
    public static final RegistryObject<PlacedFeature> MUD_SPLATTER = register("mud_splatter", BOPMiscOverworldFeatures.MUD_SPLATTER, () -> List.of(CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome()));
