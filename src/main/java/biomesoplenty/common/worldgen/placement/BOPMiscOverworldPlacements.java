...
public class BOPMiscOverworldPlacements
{
    ...
    public static final PlacedFeature CRAG_SPLATTER = register("crag_splatter", BOPMiscOverworldFeatures.CRAG_SPLATTER.placed(CountPlacement.of(128), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome()));
    ...
    public static final PlacedFeature GRASS_SPLATTER = register("grass_splatter", BOPMiscOverworldFeatures.GRASS_SPLATTER.placed(CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome()));
