...
public class BOPVegetationPlacements
{
    ...
    public static final RegistryObject<PlacedFeature> PATCH_ICY_IRIS = register("patch_icy_iris", BOPVegetationFeatures.PATCH_ICY_IRIS, () -> List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> PATCH_TALL_LAVENDER = register("patch_tall_lavender", BOPVegetationFeatures.PATCH_TALL_LAVENDER, () -> List.of(RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
    ...
    // Flowers
    public static final RegistryObject<PlacedFeature> FLOWER_LAVENDER = register("flower_lavender", BOPVegetationFeatures.FLOWER_LAVENDER, () -> VegetationPlacements.worldSurfaceSquaredWithCount(15));
    ...
    public static final RegistryObject<PlacedFeature> FLOWER_SHRUBLAND = register("flower_shrubland", BOPVegetationFeatures.FLOWER_SHRUBLAND, () -> List.of(RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
    ...
    public static final RegistryObject<PlacedFeature> FLOWER_VIOLET = register("flower_violet", BOPVegetationFeatures.FLOWER_VIOLET, () -> VegetationPlacements.worldSurfaceSquaredWithCount(2));
    ...
    public static final RegistryObject<PlacedFeature> LILAC_NORMAL = register("patch_lilac_normal", BOPVegetationFeatures.PATCH_LILAC, () -> List.of(RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
    ...
    // Trees
    public static final RegistryObject<PlacedFeature> TREES_AURORAL_GARDEN = register("trees_auroral_garden", BOPVegetationFeatures.TREES_AURORAL_GARDEN, () -> treePlacement(PlacementUtils.countExtra(10, 0.2F, 1)));
    ...
    public static final RegistryObject<PlacedFeature> TREES_LAVENDER_FOREST = register("trees_lavender_forest", BOPVegetationFeatures.TREES_LAVENDER_FOREST, () -> treePlacement(PlacementUtils.countExtra(9, 0.1F, 1)));
