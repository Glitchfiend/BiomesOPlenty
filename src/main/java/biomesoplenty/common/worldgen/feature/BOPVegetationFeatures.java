...
public class BOPVegetationFeatures
{
    ...
    public static final ConfiguredFeature<RandomPatchConfiguration, ?> PATCH_DESERT_GRASS = register("patch_desert_grass", Feature.RANDOM_PATCH.configured(FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(BOPBlocks.DESERT_GRASS))))));
    ...
    public static final ConfiguredFeature<NoneFeatureConfiguration, ?> SCRUB = register("scrub", BOPBaseFeatures.SCRUB.configured(NoneFeatureConfiguration.INSTANCE));
    ...
    public static final ConfiguredFeature<RandomPatchConfiguration, ?> FLOWER_SCRUBLAND = register("flower_scrubland", Feature.RANDOM_PATCH.configured(FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(BOPBlocks.WILDFLOWER))))));
