...
public class BOPMiscOverworldFeatures
{
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_BASALT = createKey("disk_hot_spring_basalt");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_PACKED_MUD = createKey("disk_hot_spring_packed_mud");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_THERMAL_CALCITE = createKey("disk_hot_spring_thermal_calcite");

    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_VOLCANO_SMOOTH_BASALT = createKey("disk_volcano_smooth_basalt");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_VOLCANO_BLACK_SANDSTONE = createKey("disk_volcano_black_sandstone");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_VOLCANO_MAGMA = createKey("disk_volcano_magma");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORIGIN_GRAVEL_CLIFFS = createKey("origin_gravel_cliffs");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context)
    {
        ...
        register(context, BOPMiscOverworldFeatures.DISK_VOLCANO_SMOOTH_BASALT, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.SMOOTH_BASALT), BlockPredicate.matchesBlocks(List.of(Blocks.TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA, Blocks.CYAN_TERRACOTTA, Blocks.LIGHT_BLUE_TERRACOTTA, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.BASALT, Blocks.SMOOTH_BASALT, BOPBlocks.BLACK_SAND.get(), BOPBlocks.MOSSY_BLACK_SAND.get())), UniformInt.of(6, 8), 4));
        register(context, BOPMiscOverworldFeatures.DISK_VOLCANO_BLACK_SANDSTONE, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(BOPBlocks.BLACK_SANDSTONE.get()), BlockPredicate.matchesBlocks(List.of(Blocks.TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA, Blocks.CYAN_TERRACOTTA, Blocks.LIGHT_BLUE_TERRACOTTA, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.BASALT, Blocks.SMOOTH_BASALT, BOPBlocks.BLACK_SAND.get(), BOPBlocks.BLACK_SANDSTONE.get(), BOPBlocks.MOSSY_BLACK_SAND.get())), UniformInt.of(4, 6), 3));
        register(context, BOPMiscOverworldFeatures.DISK_VOLCANO_MAGMA, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.MAGMA_BLOCK), BlockPredicate.matchesBlocks(List.of(Blocks.TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA, Blocks.CYAN_TERRACOTTA, Blocks.LIGHT_BLUE_TERRACOTTA, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.BASALT, Blocks.SMOOTH_BASALT, BOPBlocks.BLACK_SAND.get(), BOPBlocks.BLACK_SANDSTONE.get(), BOPBlocks.MOSSY_BLACK_SAND.get())), UniformInt.of(1, 3), 2));
