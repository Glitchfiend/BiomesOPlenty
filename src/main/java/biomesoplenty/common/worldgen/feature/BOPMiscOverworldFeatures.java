...
public class BOPMiscOverworldFeatures
{
    ...
    public static final ConfiguredFeature<DiskConfiguration, ?> DISK_WHITE_SAND_EXTRA = register("disk_white_sand_extra", Feature.DISK.configured(new DiskConfiguration(BOPBlocks.WHITE_SAND.defaultBlockState(), UniformInt.of(2, 6), 1, List.of(Blocks.DIRT.defaultBlockState(), Blocks.GRASS_BLOCK.defaultBlockState()))));
    ...
    public static final ConfiguredFeature<?, ?> GRASS_SPLATTER = register("grass_splatter", BOPBaseFeatures.GRASS_SPLATTER.configured(NoneFeatureConfiguration.INSTANCE));
