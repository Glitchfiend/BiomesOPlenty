...
public class BOPMiscOverworldFeatures
{
    ...
    public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> DISK_MUD = register("disk_mud", Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(BOPBlocks.MUD.get()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(4, 6), 2));
