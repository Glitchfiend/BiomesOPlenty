...
public class BOPTreeFeatures
{
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> JACARANDA_TREE = register("jacaranda_tree", BOPBaseFeatures.BASIC_TREE.configured(new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.JACARANDA_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.JACARANDA_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> ORIGIN_TREE = register("origin_tree", BOPBaseFeatures.BASIC_TREE.configured(new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.OAK_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.ORIGIN_LEAVES)).minHeight(5).maxHeight(8).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> PINK_CHERRY_TREE = register("pink_cherry_tree", BOPBaseFeatures.BASIC_TREE.configured(new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.CHERRY_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.PINK_CHERRY_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> RAINBOW_BIRCH_TREE = register("rainbow_birch_tree", BOPBaseFeatures.BASIC_TREE.configured(new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.BIRCH_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.RAINBOW_BIRCH_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> WHITE_CHERRY_TREE = register("white_cherry_tree", BOPBaseFeatures.BASIC_TREE.configured(new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.CHERRY_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.WHITE_CHERRY_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> BIG_ORIGIN_TREE = register("big_origin_tree", BOPBaseFeatures.BIG_TREE.configured(new BigTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.OAK_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.ORIGIN_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> BIG_RAINBOW_BIRCH_TREE = register("big_rainbow_birch_tree", BOPBaseFeatures.BIG_TREE.configured(new BigTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.BIRCH_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.RAINBOW_BIRCH_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> GIANT_TREE = register("giant_tree", BOPBaseFeatures.BIG_TREE.configured(new BigTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.DARK_OAK_LOG)).foliage(BlockStateProvider.simple(Blocks.DARK_OAK_LEAVES.defaultBlockState().setValue(LeavesBlock.PERSISTENT, true))).minHeight(15).maxHeight(20).trunkWidth(4).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> TALL_UMBRAN_TREE = register("tall_umbran_tree", BOPBaseFeatures.TAIGA_TREE.configured(new TaigaTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.UMBRAN_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.UMBRAN_LEAVES)).minHeight(20).maxHeight(30).trunkWidth(2).build()));
    ...
    // Poplar trees
    public static final ConfiguredFeature<TreeConfiguration, ?> BIG_MAGIC_TREE = register("big_magic_tree", BOPBaseFeatures.POPLAR_TREE.configured(new PoplarTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAGIC_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.MAGIC_LEAVES)).minHeight(16).maxHeight(20).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> MAGIC_TREE = register("magic_tree", BOPBaseFeatures.POPLAR_TREE.configured(new PoplarTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAGIC_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.MAGIC_LEAVES)).minHeight(8).maxHeight(12).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> JUNGLE_BUSH = register("jungle_bush", BOPBaseFeatures.BUSH_TREE.configured(new BasicTreeConfiguration.Builder().maxHeight(2).minHeight(2).trunk(BlockStateProvider.simple(Blocks.JUNGLE_LOG)).foliage(BlockStateProvider.simple(Blocks.JUNGLE_LEAVES)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> OAK_BUSH = register("oak_bush", BOPBaseFeatures.BUSH_TREE.configured(new BasicTreeConfiguration.Builder().maxHeight(2).minHeight(2).trunk(BlockStateProvider.simple(Blocks.OAK_LOG)).foliage(BlockStateProvider.simple(Blocks.OAK_LEAVES)).build()));
    public static final ConfiguredFeature<TreeConfiguration, ?> SPRUCE_BUSH = register("spruce_bush", BOPBaseFeatures.BUSH_TREE.configured(new BasicTreeConfiguration.Builder().maxHeight(2).minHeight(2).trunk(BlockStateProvider.simple(Blocks.SPRUCE_LOG)).foliage(BlockStateProvider.simple(Blocks.SPRUCE_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> HELLBARK_TREE = register("hellbark_tree", BOPBaseFeatures.TWIGLET_TREE.configured(new TwigletTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.HELLBARK_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.HELLBARK_LEAVES)).build()));
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> PALM_TREE = register("palm_tree", BOPBaseFeatures.PALM_TREE.configured(new PalmTreeConfiguration.Builder().build()));
