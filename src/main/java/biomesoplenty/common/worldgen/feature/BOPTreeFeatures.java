...
public class BOPTreeFeatures
{
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIG_FLOWERING_OAK_TREE_BEES = createKey("big_flowering_oak_tree_bees");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIG_JACARANDA_TREE_BEES = createKey("big_jacaranda_tree_bees");
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIG_RED_MAPLE_TREE = createKey("big_red_maple_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIG_ORANGE_MAPLE_TREE = createKey("big_orange_maple_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIG_YELLOW_MAPLE_TREE = createKey("big_yellow_maple_tree");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context)
    {
        ...
        register(context, BOPTreeFeatures.JACARANDA_TREE, BOPBaseFeatures.BASIC_TREE, new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.JACARANDA_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.JACARANDA_LEAVES.get())).hanging(BlockStateProvider.simple(BOPBlocks.JACARANDA_LEAVES.get())).build());
        register(context, BOPTreeFeatures.JACARANDA_TREE_BEES, BOPBaseFeatures.BASIC_TREE, new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.JACARANDA_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.JACARANDA_LEAVES.get())).hanging(BlockStateProvider.simple(BOPBlocks.JACARANDA_LEAVES.get())).decorator(new BeehiveDecorator(0.05f)).build());
        register(context, BOPTreeFeatures.RED_MAPLE_TREE, BOPBaseFeatures.BASIC_TREE, new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAPLE_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.RED_MAPLE_LEAVES.get())).minHeight(5).maxHeight(10).build());
        register(context, BOPTreeFeatures.ORANGE_MAPLE_TREE, BOPBaseFeatures.BASIC_TREE, new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAPLE_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.ORANGE_MAPLE_LEAVES.get())).minHeight(5).maxHeight(8).build());
        register(context, BOPTreeFeatures.YELLOW_MAPLE_TREE, BOPBaseFeatures.BASIC_TREE, new BasicTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAPLE_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.YELLOW_MAPLE_LEAVES.get())).minHeight(5).maxHeight(8).build());
        ...
        register(context, BOPTreeFeatures.ASPEN_TREE, BOPBaseFeatures.POPLAR_TREE, new PoplarTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.BIRCH_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.YELLOW_MAPLE_LEAVES.get())).maxHeight(20).build());
        ...
        register(context, BOPTreeFeatures.BIG_RED_MAPLE_TREE, BOPBaseFeatures.BIG_TREE, new BigTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAPLE_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.RED_MAPLE_LEAVES.get())).build());
        register(context, BOPTreeFeatures.BIG_ORANGE_MAPLE_TREE, BOPBaseFeatures.BIG_TREE, new BigTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAPLE_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.ORANGE_MAPLE_LEAVES.get())).build());
        register(context, BOPTreeFeatures.BIG_YELLOW_MAPLE_TREE, BOPBaseFeatures.BIG_TREE, new BigTreeConfiguration.Builder().trunk(BlockStateProvider.simple(BOPBlocks.MAPLE_LOG.get())).foliage(BlockStateProvider.simple(BOPBlocks.YELLOW_MAPLE_LEAVES.get())).build());
        ...
        register(context, BOPTreeFeatures.SNOWBLOSSOM_TWIGLET_TREE, BOPBaseFeatures.TWIGLET_TREE, new TwigletTreeConfiguration.Builder().trunk(BlockStateProvider.simple(Blocks.CHERRY_LOG)).foliage(BlockStateProvider.simple(BOPBlocks.SNOWBLOSSOM_LEAVES.get())).minHeight(2).maxHeight(2).leafChance(1.0F, 1.0F).build());
