...
public class BOPStructureSettings extends StructureSettings
{
    ...
    public static void registerStructuresBOP(BiConsumer<ConfiguredStructureFeature<?, ?>, ResourceKey<Biome>> mapper)
    {
        ...
        Set<ResourceKey<Biome>> jungleTempleBiomes = ImmutableSet.<ResourceKey<Biome>>builder().add(BOPBiomes.RAINFOREST).add(BOPBiomes.RAINFOREST_FLOODPLAIN).build();
        ...
        Set<ResourceKey<Biome>> beachStructureBiomes = ImmutableSet.<ResourceKey<Biome>>builder().add(BOPBiomes.DUNES).add(BOPBiomes.GRAVEL_BEACH).build();
        ...
        Set<ResourceKey<Biome>> ruinedPortalDesertBiomes = ImmutableSet.<ResourceKey<Biome>>builder().add(BOPBiomes.COLD_DESERT).add(BOPBiomes.DRYLAND).add(BOPBiomes.DRY_BONEYARD).add(BOPBiomes.DUNES).add(BOPBiomes.LUSH_DESERT).add(BOPBiomes.LUSH_SAVANNA).add(BOPBiomes.VOLCANIC_PLAINS).add(BOPBiomes.WASTELAND).build();
        ...
        Set<ResourceKey<Biome>> ruinedPortalStandardBiomes = ImmutableSet.<ResourceKey<Biome>>builder().add(BOPBiomes.BAMBOO_BLOSSOM_GROVE).add(BOPBiomes.BOREAL_FOREST).add(BOPBiomes.BURNT_FOREST).add(BOPBiomes.CHERRY_BLOSSOM_GROVE).add(BOPBiomes.CONIFEROUS_FOREST).add(BOPBiomes.DEAD_FOREST).add(BOPBiomes.DENSE_WOODLAND).add(BOPBiomes.FIELD).add(BOPBiomes.FIR_CLEARING).add(BOPBiomes.FORESTED_FIELD).add(BOPBiomes.GRASSLAND).add(BOPBiomes.GRAVEL_BEACH).add(BOPBiomes.GOLDEN_PRAIRIE).add(BOPBiomes.LAVENDER_FIELD).add(BOPBiomes.LAVENDER_FOREST).add(BOPBiomes.MEDITERRANEAN_FOREST).add(BOPBiomes.MEDITERRANEAN_LAKES).add(BOPBiomes.MUSKEG).add(BOPBiomes.MYSTIC_GROVE).add(BOPBiomes.OLD_GROWTH_DEAD_FOREST).add(BOPBiomes.OMINOUS_WOODS).add(BOPBiomes.ORCHARD).add(BOPBiomes.PRAIRIE).add(BOPBiomes.REDWOOD_FOREST).add(BOPBiomes.ROCKY_SHRUBLAND).add(BOPBiomes.SCRUBLAND).add(BOPBiomes.SHRUBLAND).add(BOPBiomes.SEASONAL_FOREST).add(BOPBiomes.SEASONAL_PUMPKIN_PATCH).add(BOPBiomes.SNOWY_CONIFEROUS_FOREST).add(BOPBiomes.SNOWY_FIR_CLEARING).add(BOPBiomes.SNOWY_MAPLE_FOREST).add(BOPBiomes.TUNDRA).add(BOPBiomes.WOODED_SCRUBLAND).add(BOPBiomes.WOODLAND).build();
        Set<ResourceKey<Biome>> ruinedPortalSwampBiomes = ImmutableSet.<ResourceKey<Biome>>builder().add(BOPBiomes.BAYOU).add(BOPBiomes.BOG).add(BOPBiomes.MARSH).add(BOPBiomes.RAINFOREST_FLOODPLAIN).add(BOPBiomes.WETLAND).build();
