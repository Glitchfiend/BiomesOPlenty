...
public class TundraBiome extends BiomeBOP
{
    public TundraBiome()
    {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.BUSH, new BushConfig(BOPBlocks.reed), TWICE_SURFACE, new FrequencyConfig(4)));
