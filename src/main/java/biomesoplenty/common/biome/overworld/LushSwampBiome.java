...
public class LushSwampBiome extends BiomeBOP
{
    public LushSwampBiome()
    {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(Feature.HUGE_RED_MUSHROOM, DefaultBiomeFeatures.HUGE_RED_MUSHROOM_CONFIG, Placement.COUNT_EXTRA_HEIGHTMAP, new AtSurfaceWithExtraConfig((int)0.5F, 0.1F, 1)));
