...
public class PastureBiome extends BiomeBOP
{
    public PastureBiome()
    {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.BUSH, new BushConfig(BOPBlocks.barley), Placement.CHANCE_HEIGHTMAP_DOUBLE, new FrequencyConfig(500)));
