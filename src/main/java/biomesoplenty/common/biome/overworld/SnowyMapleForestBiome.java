...
public class SnowyMapleForestBiome extends BiomeTemplate
{
    ...
    {
        builder.precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.ICY).depth(0.2F).scale(0.2F).temperature(-0.25F).downfall(0.5F);
    ...
    protected void configureGeneration(BiomeGenerationSettings.Builder builder)
    {
        ...
        // Vegetation
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, BOPConfiguredFeatures.SNOWY_MAPLE_FOREST_TREES);
