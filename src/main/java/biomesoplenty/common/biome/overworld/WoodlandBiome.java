...
public class WoodlandBiome extends BiomeBOP
{
    public WoodlandBiome()
    {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(BOPBiomeFeatures.EXTENDED_FLOWERS, Placement.COUNT_HEIGHTMAP_32, new FrequencyConfig(5)));
