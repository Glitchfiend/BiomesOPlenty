...
public class GroveBiome extends BiomeBOP
{
    public GroveBiome()
    {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(BOPBiomeFeatures.EXTENDED_FLOWERS, Placement.COUNT_HEIGHTMAP_32, new FrequencyConfig(6)));
