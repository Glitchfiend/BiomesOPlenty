...
public class LavenderFieldBiome extends BiomeBOP
{
    public LavenderFieldBiome()
    {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFlowerFeature(BOPBiomeFeatures.LAVENDER_FLOWERS, Placement.CHANCE_HEIGHTMAP_DOUBLE, new FrequencyConfig(500)));
