...
public class BOPRecipeProvider extends RecipeProvider
{
    ...
    protected void buildRecipes()
    {
        ...
        //Sphalerite
        slabBuilder(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_SLAB, Ingredient.of(BOPBlocks.SPHALERITE)).unlockedBy("has_sphalerite", has(BOPBlocks.SPHALERITE)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_SLAB, BOPBlocks.SPHALERITE, 2);
        stairBuilder(BOPBlocks.SPHALERITE_STAIRS, Ingredient.of(BOPBlocks.SPHALERITE)).unlockedBy("has_sphalerite", has(BOPBlocks.SPHALERITE)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_STAIRS, BOPBlocks.SPHALERITE);
        ...
        stairBuilder(BOPBlocks.POLISHED_SPHALERITE_STAIRS, Ingredient.of(BOPBlocks.POLISHED_SPHALERITE)).unlockedBy("has_polished_sphalerite", has(BOPBlocks.POLISHED_SPHALERITE)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.POLISHED_SPHALERITE_STAIRS, BOPBlocks.SPHALERITE);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.POLISHED_SPHALERITE_STAIRS, BOPBlocks.POLISHED_SPHALERITE);
        wall(RecipeCategory.DECORATIONS, BOPBlocks.POLISHED_SPHALERITE_WALL, BOPBlocks.POLISHED_SPHALERITE);
        stonecutterResultFromBase(RecipeCategory.DECORATIONS, BOPBlocks.POLISHED_SPHALERITE_WALL, BOPBlocks.SPHALERITE);
        stonecutterResultFromBase(RecipeCategory.DECORATIONS, BOPBlocks.POLISHED_SPHALERITE_WALL, BOPBlocks.POLISHED_SPHALERITE);
        this.shaped(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICKS, 4).define('#', BOPBlocks.POLISHED_SPHALERITE).pattern("##").pattern("##").unlockedBy("has_polished_sphalerite", has(BOPBlocks.POLISHED_SPHALERITE)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICKS, BOPBlocks.SPHALERITE);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICKS, BOPBlocks.POLISHED_SPHALERITE);
        slabBuilder(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_SLAB, Ingredient.of(BOPBlocks.SPHALERITE_BRICKS)).unlockedBy("has_sphalerite_bricks", has(BOPBlocks.SPHALERITE_BRICKS)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_SLAB, BOPBlocks.SPHALERITE_BRICKS, 2);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_SLAB, BOPBlocks.SPHALERITE, 2);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_SLAB, BOPBlocks.POLISHED_SPHALERITE, 2);
        stairBuilder(BOPBlocks.SPHALERITE_BRICK_STAIRS, Ingredient.of(BOPBlocks.SPHALERITE_BRICKS)).unlockedBy("has_sphalerite_bricks", has(BOPBlocks.SPHALERITE_BRICKS)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_STAIRS, BOPBlocks.SPHALERITE_BRICKS);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_STAIRS, BOPBlocks.SPHALERITE);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.SPHALERITE_BRICK_STAIRS, BOPBlocks.POLISHED_SPHALERITE);
        wall(RecipeCategory.DECORATIONS, BOPBlocks.SPHALERITE_BRICK_WALL, BOPBlocks.SPHALERITE_BRICKS);
        stonecutterResultFromBase(RecipeCategory.DECORATIONS, BOPBlocks.SPHALERITE_BRICK_WALL, BOPBlocks.SPHALERITE_BRICKS);
        ...
        // Orpiment
        slabBuilder(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_SLAB, Ingredient.of(BOPBlocks.ORPIMENT)).unlockedBy("has_orpiment", has(BOPBlocks.ORPIMENT)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_SLAB, BOPBlocks.ORPIMENT, 2);
        stairBuilder(BOPBlocks.ORPIMENT_STAIRS, Ingredient.of(BOPBlocks.ORPIMENT)).unlockedBy("has_orpiment", has(BOPBlocks.ORPIMENT)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_STAIRS, BOPBlocks.ORPIMENT);
        ...
        stairBuilder(BOPBlocks.POLISHED_ORPIMENT_STAIRS, Ingredient.of(BOPBlocks.POLISHED_ORPIMENT)).unlockedBy("has_polished_orpiment", has(BOPBlocks.POLISHED_ORPIMENT)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.POLISHED_ORPIMENT_STAIRS, BOPBlocks.ORPIMENT);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.POLISHED_ORPIMENT_STAIRS, BOPBlocks.POLISHED_ORPIMENT);
        wall(RecipeCategory.DECORATIONS, BOPBlocks.POLISHED_ORPIMENT_WALL, BOPBlocks.POLISHED_ORPIMENT);
        stonecutterResultFromBase(RecipeCategory.DECORATIONS, BOPBlocks.POLISHED_ORPIMENT_WALL, BOPBlocks.ORPIMENT);
        stonecutterResultFromBase(RecipeCategory.DECORATIONS, BOPBlocks.POLISHED_ORPIMENT_WALL, BOPBlocks.POLISHED_ORPIMENT);
        this.shaped(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_BRICKS, 4).define('#', BOPBlocks.POLISHED_ORPIMENT).pattern("##").pattern("##").unlockedBy("has_polished_orpiment", has(BOPBlocks.POLISHED_ORPIMENT)).save(output);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_BRICKS, BOPBlocks.ORPIMENT);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_BRICKS, BOPBlocks.POLISHED_ORPIMENT);
        ...
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_BRICK_SLAB, BOPBlocks.POLISHED_ORPIMENT, 2);
        ...
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, BOPBlocks.ORPIMENT_BRICK_STAIRS, BOPBlocks.POLISHED_ORPIMENT);
        ...
        // Leaf Litter
        this.shapeless(RecipeCategory.DECORATIONS, BOPBlocks.MAPLE_LEAF_LITTER, 4).requires(ModTags.Items.MAPLE_LEAVES).unlockedBy("has_maple_leaves", has(ModTags.Items.MAPLE_LEAVES)).save(output);
