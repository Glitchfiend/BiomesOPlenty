...
public class BOPBlockFamilies
{
    ...
    public static final BlockFamily ORIGIN_OAK_PLANKS = familyBuilder(BOPBlocks.ORIGIN_OAK_PLANKS).button(BOPBlocks.ORIGIN_OAK_BUTTON).fence(BOPBlocks.ORIGIN_OAK_FENCE).fenceGate(BOPBlocks.ORIGIN_OAK_FENCE_GATE).pressurePlate(BOPBlocks.ORIGIN_OAK_PRESSURE_PLATE).sign(BOPBlocks.ORIGIN_OAK_SIGN, BOPBlocks.ORIGIN_OAK_WALL_SIGN).slab(BOPBlocks.ORIGIN_OAK_SLAB).stairs(BOPBlocks.ORIGIN_OAK_STAIRS).door(BOPBlocks.ORIGIN_OAK_DOOR).trapdoor(BOPBlocks.ORIGIN_OAK_TRAPDOOR).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
    ...
    public static final BlockFamily WHITE_SANDSTONE = familyBuilder(BOPBlocks.WHITE_SANDSTONE).wall(BOPBlocks.WHITE_SANDSTONE_WALL).stairs(BOPBlocks.WHITE_SANDSTONE_STAIRS).slab(BOPBlocks.WHITE_SANDSTONE_SLAB).chiseled(BOPBlocks.CHISELED_WHITE_SANDSTONE).cut(BOPBlocks.CUT_WHITE_SANDSTONE).dontGenerateCraftingRecipe().getFamily();
