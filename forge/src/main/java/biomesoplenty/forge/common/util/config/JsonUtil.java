 ...
 * All rights reserved.
 ******************************************************************************/
package biomesoplenty.forge.common.util.config;
...
public class JsonUtil
{
    ...
    public static <T> T getOrCreateConfigFile(File configDir, String configName, T defaults, Type type)
    {
        ...
        {
            BiomesOPlentyForge.LOGGER.error("Error parsing config from json: " + configFile.toString(), e);
        }
    ...
    public static boolean writeFile(File outputFile, Object obj)
    {
        ...
        {
            BiomesOPlentyForge.LOGGER.error("Error writing config file " + outputFile.getAbsolutePath() + ": " + e.getMessage());
            return false;
        }
    }
}