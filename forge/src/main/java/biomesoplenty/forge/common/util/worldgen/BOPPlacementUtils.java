...
import biomesoplenty.forge.common.worldgen.placement.*;
...
public class BOPPlacementUtils
{
    ...
    {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(BiomesOPlentyForge.MOD_ID, name));
    }
}
