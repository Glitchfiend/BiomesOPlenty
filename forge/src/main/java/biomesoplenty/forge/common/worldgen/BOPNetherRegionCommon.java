...
import biomesoplenty.forge.common.util.biome.BiomeUtil;
...
{
    public static final ResourceLocation LOCATION = new ResourceLocation(BiomesOPlentyForge.MOD_ID, "nether_common");
