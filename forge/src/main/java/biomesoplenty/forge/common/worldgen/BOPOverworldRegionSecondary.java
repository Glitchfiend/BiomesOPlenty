...
import biomesoplenty.forge.common.biome.BOPSecondaryOverworldBiomeBuilder;
...
{
    public static final ResourceLocation LOCATION = new ResourceLocation(BiomesOPlentyForge.MOD_ID, "overworld_secondary");
