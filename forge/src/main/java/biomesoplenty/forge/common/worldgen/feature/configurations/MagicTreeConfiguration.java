...
public class MagicTreeConfiguration extends BOPTreeConfiguration
{
    ...
    public static class Builder extends BOPTreeConfiguration.Builder<MagicTreeConfiguration.Builder>
    {
        public Builder()
        {
            this.trunkProvider = BlockStateProvider.simple(BOPBlocks.MAGIC_LOG.get().defaultBlockState());
            this.foliageProvider = BlockStateProvider.simple(BOPBlocks.MAGIC_LEAVES.get().defaultBlockState());
            this.minHeight = 5;
            this.maxHeight = 12;
        }
