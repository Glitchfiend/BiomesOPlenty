...
import biomesoplenty.forge.common.biome.BOPOverworldBiomeBuilder;
...
{
    public static final ResourceLocation LOCATION = new ResourceLocation(BiomesOPlentyForge.MOD_ID, "overworld_primary");
