...
import biomesoplenty.forge.common.item.BoatItemBOP;
import biomesoplenty.forge.common.item.MusicDiscItemBOP;
...
public class ModItems
{
    ...
    {
        return BiomesOPlentyForge.ITEM_REGISTER.register(name, itemSupplier);
    }
}