...
import biomesoplenty.forge.common.util.config.JsonUtil;
...
public class ModConfig
{
    ...
    {
        if (key == null || !key.location().getNamespace().equals(BiomesOPlentyForge.MOD_ID))
            return false;
    ...
    private static void createConfigDirectoryIfNecessary()
    {
        ...
        {
            BiomesOPlentyForge.LOGGER.error("Failed to create biomesoplenty config directory", e);
        }
    }
