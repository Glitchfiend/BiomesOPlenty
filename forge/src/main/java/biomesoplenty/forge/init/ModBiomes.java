...
import biomesoplenty.forge.common.biome.BOPNetherBiomes;
import biomesoplenty.forge.common.biome.BOPOverworldBiomes;
import biomesoplenty.forge.common.worldgen.*;
...
public class ModBiomes
{
    ...
    public static void setupTerraBlender()
    {
        ...
        SurfaceRuleManager.addSurfaceRules(SurfaceRuleManager.RuleCategory.OVERWORLD, BiomesOPlentyForge.MOD_ID, BOPSurfaceRuleData.overworld());
        SurfaceRuleManager.addSurfaceRules(SurfaceRuleManager.RuleCategory.NETHER, BiomesOPlentyForge.MOD_ID, BOPSurfaceRuleData.nether());
    }
