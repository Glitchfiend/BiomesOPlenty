...
public class JacarandaLeavesBlock extends TintedParticleLeavesBlock
{
    public JacarandaLeavesBlock(Properties p_273704_)
    {
    ...
    public void animateTick(BlockState p_272714_, Level p_272837_, BlockPos p_273218_, RandomSource p_273360_)
    {
        ...
        if (p_273360_.nextInt(15) == 0)
        {
            ...
            {
                ParticleUtils.spawnParticleBelow(p_272837_, p_273218_, p_273360_, ModParticles.JACARANDA_LEAVES);
            }
        }
    }
}