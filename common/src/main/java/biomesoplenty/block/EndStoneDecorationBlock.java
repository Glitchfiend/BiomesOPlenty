...
public class EndStoneDecorationBlock extends Block
{
    protected static final VoxelShape SHAPE = Block.box(1.0D, 0.0D, 1.0D, 15.0D, 12.0D, 15.0D);

    public EndStoneDecorationBlock(Properties properties)
    {
        super(properties);
    }
    ...
    public boolean canSurvive(BlockState state, LevelReader worldIn, BlockPos pos)
    {
        ...
        return groundState.is(ModTags.Blocks.END_STONE_DECORATION_PLACEABLE) && groundState.isFaceSturdy(worldIn, pos.below(), Direction.UP);
    }
