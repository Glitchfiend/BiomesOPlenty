...
public class NormalLeafParticle extends TextureSheetParticle {
    ...
    public NormalLeafParticle(ClientLevel p_377646_, double p_377442_, double p_376050_, double p_377918_, SpriteSet p_376948_)
    {
