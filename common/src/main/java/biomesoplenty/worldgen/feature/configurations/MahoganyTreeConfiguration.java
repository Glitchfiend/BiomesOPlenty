...
{
    public static final MapCodec<MahoganyTreeConfiguration> CODEC = RecordCodecBuilder.mapCodec((builder) -> {
    ...
    public static class Builder extends BOPTreeConfiguration.Builder<MahoganyTreeConfiguration.Builder>
    {
        public Builder()
        {
            this.trunkProvider = BlockStateProvider.of(BOPBlocks.MAHOGANY_LOG.defaultBlockState());
            this.foliageProvider = BlockStateProvider.of(BOPBlocks.MAHOGANY_LEAVES.defaultBlockState());
            this.minHeight = 8;
            this.maxHeight = 14;
        }
