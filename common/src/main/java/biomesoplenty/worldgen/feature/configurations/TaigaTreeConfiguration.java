...
{
    public static final MapCodec<TaigaTreeConfiguration> CODEC = RecordCodecBuilder.mapCodec((builder) -> {
    ...
    public static class Builder extends BOPTreeConfiguration.Builder<Builder>
    {
        ...
        public Builder()
        {
            this.minHeight = 6;
            this.maxHeight = 12;
            this.trunkProvider = BlockStateProvider.of(Blocks.SPRUCE_LOG.defaultBlockState());
            this.foliageProvider = BlockStateProvider.of(Blocks.SPRUCE_LEAVES.defaultBlockState());
            this.vineProvider = BlockStateProvider.of(Blocks.VINE.defaultBlockState());
            this.trunkWidth = 1;
        }
