...
public class EmpyrealTreeConfiguration extends BOPTreeConfiguration
{
    public static final Codec<EmpyrealTreeConfiguration> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        ).apply(builder, EmpyrealTreeConfiguration::new);
    });

    protected EmpyrealTreeConfiguration(BlockStateProvider trunkProvider, BlockStateProvider foliageProvider, BlockStateProvider vineProvider, BlockStateProvider hangingProvider, BlockStateProvider trunkFruitProvider, BlockStateProvider altFoliageProvider, int minHeight, int maxHeight, List<TreeDecorator> decorators)
    {
    ...
    public static class Builder extends BOPTreeConfiguration.Builder<EmpyrealTreeConfiguration.Builder>
    {
        public Builder()
        {
            this.minHeight = 3;
