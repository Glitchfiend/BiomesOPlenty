...
{
    public static final MapCodec<MagicTreeConfiguration> CODEC = RecordCodecBuilder.mapCodec((builder) -> {
    ...
    public static class Builder extends BOPTreeConfiguration.Builder<MagicTreeConfiguration.Builder>
    {
        public Builder()
        {
            this.trunkProvider = BlockStateProvider.of(BOPBlocks.MAGIC_LOG.defaultBlockState());
            this.foliageProvider = BlockStateProvider.of(BOPBlocks.MAGIC_LEAVES.defaultBlockState());
            this.minHeight = 5;
            this.maxHeight = 12;
        }
