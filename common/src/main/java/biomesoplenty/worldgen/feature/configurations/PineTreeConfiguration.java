...
{
    public static final MapCodec<PineTreeConfiguration> CODEC = RecordCodecBuilder.mapCodec((builder) -> {
    ...
    public static class Builder extends BOPTreeConfiguration.Builder<PineTreeConfiguration.Builder>
    {
        public Builder()
        {
            this.trunkProvider = BlockStateProvider.of(BOPBlocks.PINE_LOG.defaultBlockState());
            this.foliageProvider = BlockStateProvider.of(BOPBlocks.PINE_LEAVES.defaultBlockState());
            this.minHeight = 10;
            this.maxHeight = 15;
        }
