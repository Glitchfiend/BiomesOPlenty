...
public class BOPMiscOverworldFeatures
{
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_CINNABAR = BOPFeatureUtils.createKey("disk_hot_spring_cinnabar");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_BRIMSTONE = BOPFeatureUtils.createKey("disk_hot_spring_brimstone");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_SULFUR = BOPFeatureUtils.createKey("disk_hot_spring_sulfur");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_SURFACE_CLAY = BOPFeatureUtils.createKey("disk_surface_clay");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> OBSIDIAN_LAKE = BOPFeatureUtils.createKey("obsidian_lake");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context)
    {
        ...
        register(context, BOPMiscOverworldFeatures.DISK_CALCITE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.CALCITE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.SAND, Blocks.GRAVEL, Blocks.GRANITE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.COAL_ORE, Blocks.IRON_ORE, Blocks.STONE, Blocks.CALCITE)), UniformInt.of(3, 7), 2));
        register(context, BOPMiscOverworldFeatures.DISK_GRAVEL_EXTRA, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.GRAVEL), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(1, 4), 2));
        register(context, BOPMiscOverworldFeatures.DISK_ORANGE_SAND, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.ORANGE_SAND), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(2, 6), 2));
        register(context, BOPMiscOverworldFeatures.DISK_WHITE_SAND, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.WHITE_SAND), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(2, 6), 2));
        register(context, BOPMiscOverworldFeatures.DISK_WHITE_SAND_EXTRA, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.WHITE_SAND), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.MYCELIUM, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, BOPBlocks.ORIGIN_GRASS_BLOCK)), UniformInt.of(6, 8), 2));
        register(context, BOPMiscOverworldFeatures.DISK_WHITE_SANDSTONE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.WHITE_SANDSTONE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.STONE, Blocks.SANDSTONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE)), UniformInt.of(6, 8), 2));

        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_GRAVEL, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.GRAVEL), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE)), UniformInt.of(8, 8), 4));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_CALCITE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.CALCITE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE)), UniformInt.of(6, 7), 3));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_BASALT, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.SMOOTH_BASALT), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.CALCITE)), UniformInt.of(5, 6), 2));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_PACKED_MUD, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.PACKED_MUD), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.SMOOTH_BASALT, Blocks.CALCITE)), UniformInt.of(4, 4), 1));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_CINNABAR, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.CINNABAR), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.PACKED_MUD, Blocks.SMOOTH_BASALT, Blocks.CALCITE)), UniformInt.of(4, 5), 1));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_BRIMSTONE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.BRIMSTONE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.PACKED_MUD, Blocks.SMOOTH_BASALT, Blocks.CALCITE, Blocks.CINNABAR)), UniformInt.of(3, 4), 1));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_SULFUR, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.SULFUR), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.PACKED_MUD, Blocks.SMOOTH_BASALT, Blocks.CALCITE, Blocks.CINNABAR, BOPBlocks.BRIMSTONE)), UniformInt.of(1, 3), 1));
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_THERMAL_CALCITE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.THERMAL_CALCITE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.PACKED_MUD, Blocks.SMOOTH_BASALT, Blocks.CALCITE, Blocks.CINNABAR, BOPBlocks.BRIMSTONE, Blocks.SULFUR)), UniformInt.of(1, 2), 1));

        register(context, BOPMiscOverworldFeatures.DISK_VOLCANO_SMOOTH_BASALT, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.SMOOTH_BASALT), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.TERRACOTTA, Blocks.DYED_TERRACOTTA.lightGray(), Blocks.DYED_TERRACOTTA.cyan(), Blocks.DYED_TERRACOTTA.lightBlue(), Blocks.DYED_TERRACOTTA.blue(), Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.BASALT, Blocks.SMOOTH_BASALT, BOPBlocks.BLACK_SAND, BOPBlocks.MOSSY_BLACK_SAND)), UniformInt.of(6, 8), 4));
        register(context, BOPMiscOverworldFeatures.DISK_VOLCANO_BLACK_SANDSTONE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.BLACK_SANDSTONE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.TERRACOTTA, Blocks.DYED_TERRACOTTA.lightGray(), Blocks.DYED_TERRACOTTA.cyan(), Blocks.DYED_TERRACOTTA.lightBlue(), Blocks.DYED_TERRACOTTA.blue(), Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.BASALT, Blocks.SMOOTH_BASALT, BOPBlocks.BLACK_SAND, BOPBlocks.BLACK_SANDSTONE, BOPBlocks.MOSSY_BLACK_SAND)), UniformInt.of(4, 6), 3));
        register(context, BOPMiscOverworldFeatures.DISK_VOLCANO_MAGMA, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.MAGMA_BLOCK), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.TERRACOTTA, Blocks.DYED_TERRACOTTA.lightGray(), Blocks.DYED_TERRACOTTA.cyan(), Blocks.DYED_TERRACOTTA.lightBlue(), Blocks.DYED_TERRACOTTA.blue(), Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.BASALT, Blocks.SMOOTH_BASALT, BOPBlocks.BLACK_SAND, BOPBlocks.BLACK_SANDSTONE, BOPBlocks.MOSSY_BLACK_SAND)), UniformInt.of(1, 3), 2));

        register(context, BOPMiscOverworldFeatures.DISK_SURFACE_CLAY, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.CLAY), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(4, 6), 2));
        register(context, BOPMiscOverworldFeatures.DISK_MUD, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(Blocks.MUD), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(4, 6), 2));
        ...
        register(context, BOPMiscOverworldFeatures.WATER_LAKE, BOPBaseFeatures.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), BlockStateProvider.simple(Blocks.AIR.defaultBlockState()), BlockPredicate.alwaysTrue(), BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.FEATURES_CANNOT_REPLACE)), BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE))));
        register(context, BOPMiscOverworldFeatures.HOT_SPRING_LAKE, BOPBaseFeatures.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), BlockStateProvider.simple(Blocks.AIR.defaultBlockState()), BlockPredicate.alwaysTrue(), BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.FEATURES_CANNOT_REPLACE)), BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE))));
        register(context, BOPMiscOverworldFeatures.OBSIDIAN_LAKE, Feature.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(Blocks.OBSIDIAN.defaultBlockState()), BlockStateProvider.simple(BOPBlocks.BLACK_SANDSTONE.defaultBlockState()), BlockPredicate.alwaysTrue(), BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.FEATURES_CANNOT_REPLACE)), BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE))));
