...
public class BOPMiscOverworldFeatures
{
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_ORPIMENT = BOPFeatureUtils.createKey("disk_hot_spring_orpiment");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DISK_HOT_SPRING_SPHALERITE = BOPFeatureUtils.createKey("disk_hot_spring_sphalerite");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context)
    {
        ...
        register(context, BOPMiscOverworldFeatures.DISK_HOT_SPRING_SPHALERITE, Feature.DISK, new DiskConfiguration(new RuleBasedStateProvider(BlockStateProvider.simple(BOPBlocks.SPHALERITE), List.of()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.GRAVEL, Blocks.CLAY, Blocks.ANDESITE, Blocks.GRANITE, Blocks.DIORITE, Blocks.STONE, Blocks.PACKED_MUD, Blocks.SMOOTH_BASALT, Blocks.CALCITE, Blocks.CINNABAR, BOPBlocks.ORPIMENT, Blocks.SULFUR)), UniformInt.of(1, 2), 1));
