...
public class HugeToadstoolFeature implements Feature
{
    ...
    public static final MapCodec<HugeToadstoolFeature> CODEC = MapCodec.unit(HugeToadstoolFeature::new);

    @Override
    public MapCodec<HugeToadstoolFeature> codec()
    {
        return CODEC;
    }
