...
public class DeadCoralPatchFeature implements Feature
{
    public static final MapCodec<DeadCoralPatchFeature> CODEC = MapCodec.unit(DeadCoralPatchFeature::new);

    @Override
    public MapCodec<DeadCoralPatchFeature> codec()
    {
        return CODEC;
    }
