...
public class BigPumpkinFeature implements Feature
{
    ...
    public static final MapCodec<BigPumpkinFeature> CODEC = MapCodec.unit(BigPumpkinFeature::new);

    @Override
    public MapCodec<BigPumpkinFeature> codec()
    {
        return CODEC;
    }
