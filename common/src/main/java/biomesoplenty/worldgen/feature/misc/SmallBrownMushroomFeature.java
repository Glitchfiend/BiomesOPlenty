...
public class SmallBrownMushroomFeature implements Feature
{
    ...
    public static final MapCodec<SmallBrownMushroomFeature> CODEC = MapCodec.unit(SmallBrownMushroomFeature::new);

    @Override
    public MapCodec<SmallBrownMushroomFeature> codec()
    {
        return CODEC;
    }
