...
public class RootedStumpFeature implements Feature
{
    ...
    public static final MapCodec<RootedStumpFeature> CODEC = MapCodec.unit(RootedStumpFeature::new);

    @Override
    public MapCodec<RootedStumpFeature> codec()
    {
        return CODEC;
    }
