...
public class BoneSpineFeature implements Feature
{
    ...
    public static final MapCodec<BoneSpineFeature> CODEC = MapCodec.unit(BoneSpineFeature::new);

    @Override
    public MapCodec<BoneSpineFeature> codec()
    {
        return CODEC;
    }
