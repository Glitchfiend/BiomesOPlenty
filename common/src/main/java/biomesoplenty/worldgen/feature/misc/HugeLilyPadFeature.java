...
public class HugeLilyPadFeature extends Feature<NoneFeatureConfiguration>
{
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> featurePlaceContext)
    {
        ...
        this.setBlock(world, pos, BOPBlocks.HUGE_LILY_PAD.defaultBlockState().setValue(HugeLilyPadBlock.QUARTER, QuarterProperty.SOUTH_WEST).setValue(HorizontalDirectionalBlock.FACING, direction));
        this.setBlock(world, pos.relative(direction), BOPBlocks.HUGE_LILY_PAD.defaultBlockState().setValue(HugeLilyPadBlock.QUARTER, QuarterProperty.NORTH_WEST).setValue(HorizontalDirectionalBlock.FACING, direction));
        this.setBlock(world, pos.relative(direction).relative(direction.getClockWise()), BOPBlocks.HUGE_LILY_PAD.defaultBlockState().setValue(HugeLilyPadBlock.QUARTER, QuarterProperty.NORTH_EAST).setValue(HorizontalDirectionalBlock.FACING, direction));
        this.setBlock(world, pos.relative(direction.getClockWise()), BOPBlocks.HUGE_LILY_PAD.defaultBlockState().setValue(HugeLilyPadBlock.QUARTER, QuarterProperty.SOUTH_EAST).setValue(HorizontalDirectionalBlock.FACING, direction));
