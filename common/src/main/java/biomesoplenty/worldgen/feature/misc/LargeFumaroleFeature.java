...
public class LargeFumaroleFeature implements Feature
{
    ...
    public static final MapCodec<LargeFumaroleFeature> CODEC = MapCodec.unit(LargeFumaroleFeature::new);

    @Override
    public MapCodec<LargeFumaroleFeature> codec()
    {
        return CODEC;
    }
