...
public class ExtraGlowLichenFeature implements Feature
{
    public static final MapCodec<ExtraGlowLichenFeature> CODEC = MapCodec.unit(ExtraGlowLichenFeature::new);

    @Override
    public MapCodec<ExtraGlowLichenFeature> codec()
    {
        return CODEC;
    }
