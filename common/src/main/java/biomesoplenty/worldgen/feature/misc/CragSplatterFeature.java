...
public class CragSplatterFeature implements Feature
{
    public static final MapCodec<CragSplatterFeature> CODEC = MapCodec.unit(CragSplatterFeature::new);

    @Override
    public MapCodec<CragSplatterFeature> codec()
    {
        return CODEC;
    }
