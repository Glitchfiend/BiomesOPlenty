...
public class MediumGlowshroomFeature implements Feature
{
    ...
    public static final MapCodec<MediumGlowshroomFeature> CODEC = MapCodec.unit(MediumGlowshroomFeature::new);

    @Override
    public MapCodec<MediumGlowshroomFeature> codec()
    {
        return CODEC;
    }
