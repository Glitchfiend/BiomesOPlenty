...
public class CragMossFeature implements Feature
{
    public static final MapCodec<CragMossFeature> CODEC = MapCodec.unit(CragMossFeature::new);

    @Override
    public MapCodec<CragMossFeature> codec()
    {
        return CODEC;
    }
