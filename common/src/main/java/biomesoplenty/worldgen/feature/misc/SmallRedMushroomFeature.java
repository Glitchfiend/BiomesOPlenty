...
public class SmallRedMushroomFeature implements Feature
{
    ...
    public static final MapCodec<SmallRedMushroomFeature> CODEC = MapCodec.unit(SmallRedMushroomFeature::new);

    @Override
    public MapCodec<SmallRedMushroomFeature> codec()
    {
        return CODEC;
    }
