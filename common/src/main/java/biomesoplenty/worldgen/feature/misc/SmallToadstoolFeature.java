...
public class SmallToadstoolFeature implements Feature
{
    ...
    public static final MapCodec<SmallToadstoolFeature> CODEC = MapCodec.unit(SmallToadstoolFeature::new);

    @Override
    public MapCodec<SmallToadstoolFeature> codec()
    {
        return CODEC;
    }
