...
public class HugeGlowshroomFeature implements Feature
{
    ...
    public static final MapCodec<HugeGlowshroomFeature> CODEC = MapCodec.unit(HugeGlowshroomFeature::new);

    @Override
    public MapCodec<HugeGlowshroomFeature> codec()
    {
        return CODEC;
    }
