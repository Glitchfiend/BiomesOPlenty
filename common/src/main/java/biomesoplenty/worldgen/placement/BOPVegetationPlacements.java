...
public class BOPVegetationPlacements
{
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context)
    {
        ...
        register(context, BOPVegetationPlacements.PATCH_BLUE_HYDRANGEA, PATCH_BLUE_HYDRANGEA, List.of(RarityFilter.onAverageOnceEvery(12), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        register(context, BOPVegetationPlacements.PATCH_BLUE_HYDRANGEA_EXTRA, PATCH_BLUE_HYDRANGEA, List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.PATCH_FLOWER_BUDS, PATCH_FLOWER_BUDS, RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        register(context, BOPVegetationPlacements.PATCH_FLOWER_BUDS_EXTRA, PATCH_FLOWER_BUDS, VegetationPlacements.worldSurfaceSquaredWithCount(16));
        ...
        register(context, BOPVegetationPlacements.PATCH_ICY_IRIS, PATCH_ICY_IRIS, VegetationPlacements.worldSurfaceSquaredWithCount(7));
        register(context, BOPVegetationPlacements.PATCH_PITCHER_PLANT, PATCH_PITCHER_PLANT, RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        ...
        register(context, BOPVegetationPlacements.FLOWER_LUSH_DESERT, FLOWER_PURPLE_WILDFLOWERS, List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.FLOWER_POPPY, FLOWER_POPPY, VegetationPlacements.worldSurfaceSquaredWithCount(10));
        register(context, BOPVegetationPlacements.FLOWER_PUMPKIN_PATCH, FLOWER_SEASONAL_FOREST, List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.FLOWER_SCRUBLAND, FLOWER_PURPLE_WILDFLOWERS, List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        register(context, BOPVegetationPlacements.FLOWER_SEASONAL_FOREST, FLOWER_SEASONAL_FOREST, List.of(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.FLOWER_SUBTROPICS, FLOWER_SUBTROPICS, List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.FLOWER_VIOLET, FLOWER_VIOLET, VegetationPlacements.worldSurfaceSquaredWithCount(1));
        ...
        register(context, BOPVegetationPlacements.FLOWER_PURPLE_WILDFLOWERS, FLOWER_PURPLE_WILDFLOWERS, List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.ROSE_BUSH_EXTRA, ROSE_BUSH, List.of(RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, BOPVegetationPlacements.RED_MAPLE_LEAF_LITTER, RED_MAPLE_LEAF_LITTER, VegetationPlacements.worldSurfaceSquaredWithCount(2));
        register(context, BOPVegetationPlacements.ORANGE_MAPLE_LEAF_LITTER, ORANGE_MAPLE_LEAF_LITTER, VegetationPlacements.worldSurfaceSquaredWithCount(2));
        register(context, BOPVegetationPlacements.YELLOW_MAPLE_LEAF_LITTER, YELLOW_MAPLE_LEAF_LITTER, VegetationPlacements.worldSurfaceSquaredWithCount(2));
