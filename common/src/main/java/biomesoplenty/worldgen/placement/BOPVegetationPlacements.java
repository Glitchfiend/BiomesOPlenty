...
public class BOPVegetationPlacements
{
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context)
    {
        ...
        final Holder<ConfiguredFeature<?, ?>> HUGE_BROWN_MUSHROOM = configuredFeatureGetter.getOrThrow(TreeFeatures.HUGE_BROWN_MUSHROOM);
        ...
        final Holder<ConfiguredFeature<?, ?>> FLOWER_PURPLE_WILDFLOWERS = configuredFeatureGetter.getOrThrow(BOPVegetationFeatures.FLOWER_PURPLE_WILDFLOWERS);
        ...
        final Holder<ConfiguredFeature<?, ?>> FLOWER_SEASONAL_FOREST = configuredFeatureGetter.getOrThrow(BOPVegetationFeatures.FLOWER_SEASONAL_FOREST);
        ...
        final Holder<ConfiguredFeature<?, ?>> FLOWER_SUBTROPICS = configuredFeatureGetter.getOrThrow(BOPVegetationFeatures.FLOWER_SUBTROPICS);
        ...
        final Holder<ConfiguredFeature<?, ?>> PRISMARINE_SPIKE = configuredFeatureGetter.getOrThrow(BOPVegetationFeatures.PRISMARINE_SPIKE);

        register(context, BOPVegetationPlacements.CLOVER_NORMAL, PATCH_CLOVER, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(2), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.CLOVER_EXTRA, PATCH_CLOVER, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(7), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.PATCH_BARLEY, PATCH_BARLEY, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(10), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_BARLEY_SPARSE, PATCH_BARLEY, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.PATCH_BLUE_HYDRANGEA, PATCH_BLUE_HYDRANGEA, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(12), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.PATCH_BLUE_HYDRANGEA_EXTRA, PATCH_BLUE_HYDRANGEA, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.PATCH_BUSH_1, PATCH_BUSH, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(1), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_BUSH_4, PATCH_BUSH, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(3), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_BOG_BERRY_BUSH, PATCH_BERRY_BUSH, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(2), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_CATTAIL_NORMAL, PATCH_CATTAIL, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(2), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_CATTAIL_EXTRA, PATCH_CATTAIL, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(5), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_DEAD_BUSH_4, PATCH_DEAD_BUSH, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(4), new PlacementModifier[]{CountPlacement.of(4), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.PATCH_DESERT_GRASS, PATCH_DESERT_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(1), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_DRY_GRASS_EXTRA, PATCH_DRY_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(4), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_DUNE_GRASS, PATCH_DUNE_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(4), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_FERN_2, PATCH_FERN, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(2), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_FERN_4, PATCH_FERN, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(4), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_FERN_8, PATCH_FERN, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(8), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_FLOWER_BUDS, PATCH_FLOWER_BUDS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.PATCH_FLOWER_BUDS_EXTRA, PATCH_FLOWER_BUDS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(16), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_GRASS_1, PATCH_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(1), new PlacementModifier[]{CountPlacement.of(32), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_GRASS_3, PATCH_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(3), new PlacementModifier[]{CountPlacement.of(32), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_GRASS_6, PATCH_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(6), new PlacementModifier[]{CountPlacement.of(32), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_GRASS_12, PATCH_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(12), new PlacementModifier[]{CountPlacement.of(32), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_GRASS_24, PATCH_GRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(24), new PlacementModifier[]{CountPlacement.of(32), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_ICY_IRIS, PATCH_ICY_IRIS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(7), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.PATCH_LARGE_FERN_NORMAL, PATCH_LARGE_FERN, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        ...
        register(context, BOPVegetationPlacements.PATCH_SEA_OATS, PATCH_SEA_OATS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(5), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.PATCH_SPROUTS_5, PATCH_SPROUTS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(1), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_SPROUTS_10, PATCH_SPROUTS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(2), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_SPROUTS_15, PATCH_SPROUTS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(6), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.PATCH_TALL_GRASS_6, PATCH_TALL_GRASS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.PATCH_TALL_GRASS_12, PATCH_TALL_GRASS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        ...
        register(context, BOPVegetationPlacements.PATCH_TUNDRA_SHRUBS, PATCH_TUNDRA_SHRUBS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(3), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.TOADSTOOL_EXTRA, TOADSTOOL_NORMAL, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(2), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.LILY_PAD_5, PATCH_WATERLILY, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(10), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.LILY_PAD_10, PATCH_WATERLILY, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(10), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.LILY_PAD_15, PATCH_WATERLILY, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(15), new PlacementModifier[]{CountPlacement.of(10), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.WATERLILY_FLOWERS, PATCH_WATERLILY_FLOWER, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(3), new PlacementModifier[]{CountPlacement.of(10), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.PATCH_REED_50, PATCH_REED, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(25), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(BlockPos.ZERO, Blocks.WATER))}));
        register(context, BOPVegetationPlacements.PATCH_WATERGRASS_10, PATCH_WATERGRASS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(BlockPos.ZERO, Blocks.WATER))});
        register(context, BOPVegetationPlacements.PATCH_WATERGRASS_50, PATCH_WATERGRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(10), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(BlockPos.ZERO, Blocks.WATER))}));
        register(context, BOPVegetationPlacements.PATCH_WATERGRASS_250, PATCH_WATERGRASS, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(100), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(BlockPos.ZERO, Blocks.WATER))}));
        register(context, BOPVegetationPlacements.FLOWER_LAVENDER, FLOWER_LAVENDER, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(15), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        register(context, BOPVegetationPlacements.FLOWER_LUSH_DESERT, FLOWER_PURPLE_WILDFLOWERS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(6, 2), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.FLOWER_CONIFEROUS_FOREST, FLOWER_CONIFEROUS_FOREST, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(64), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        ...
        register(context, BOPVegetationPlacements.FLOWER_FIELD, FLOWER_FIELD, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(64), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.FLOWER_OVERGROWN_GREENS, FLOWER_OVERGROWN_GREENS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(64), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.FLOWER_MOOR, FLOWER_MOOR, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(64), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.FLOWER_MYSTIC_GROVE, FLOWER_MYSTIC_GROVE, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(64), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        ...
        register(context, BOPVegetationPlacements.FLOWER_POPPY, FLOWER_POPPY, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(10), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
        ...
        register(context, BOPVegetationPlacements.FLOWER_SNOWBLOSSOM_GROVE, FLOWER_SNOWBLOSSOM_GROVE, NoiseThresholdCountPlacement.of(-0.8D, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(6, 2), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE));
        ...
        register(context, BOPVegetationPlacements.FLOWER_TROPICS, FLOWER_TROPICS, new PlacementModifier[]{RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), CountPlacement.of(64), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)});
        register(context, BOPVegetationPlacements.FLOWER_VIOLET, FLOWER_VIOLET, Util.copyAndAdd(VegetationPlacements.worldSurfaceSquaredWithCount(1), new PlacementModifier[]{CountPlacement.of(96), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE)}));
