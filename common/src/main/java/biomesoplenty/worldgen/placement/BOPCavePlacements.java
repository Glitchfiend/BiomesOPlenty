...
public class BOPCavePlacements
{
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context)
    {
        ...
        final Holder<Feature> WEBBING = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.WEBBING);
        final Holder<Feature> STRINGY_COBWEB = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.STRINGY_COBWEB);
        final Holder<Feature> SPIDER_EGG = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.SPIDER_EGG);
        final Holder<Feature> CORNER_COBWEBS = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.CORNER_COBWEBS);
        final Holder<Feature> HANGING_COBWEB = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.HANGING_COBWEB);
        final Holder<Feature> EXTRA_GLOW_LICHEN = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.EXTRA_GLOW_LICHEN);
        final Holder<Feature> SMALL_GLOWSHROOM_CAVE = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.SMALL_GLOWSHROOM_CAVE);
        final Holder<Feature> MEDIUM_GLOWSHROOM_CAVE = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.MEDIUM_GLOWSHROOM_CAVE);
        final Holder<Feature> HUGE_GLOWSHROOM_CAVE = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.HUGE_GLOWSHROOM_CAVE);
        final Holder<Feature> GIANT_GLOWSHROOM_CAVE = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.GIANT_GLOWSHROOM_CAVE);
        final Holder<Feature> GLOWWORM_SILK = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.GLOWWORM_SILK);
        final Holder<Feature> MUD_PATCH = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.MUD_PATCH);
        final Holder<Feature> GLOWING_MOSS_PATCH = configuredFeatureGetter.getOrThrow(BOPCaveFeatures.GLOWING_MOSS_PATCH);
        ...
        register(context, BOPCavePlacements.GLOWING_GROTTO_MUD, MUD_PATCH, List.of(CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), OffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome()));
        register(context, BOPCavePlacements.GLOWWORM_SILK_STRANDS, GLOWWORM_SILK, List.of(CountPlacement.of(200), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.UP, BlockPredicate.hasSturdyFace(Direction.DOWN), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), OffsetPlacement.vertical(ConstantInt.of(-1)), BiomeFilter.biome()));
        ...
        register(context, BOPCavePlacements.SMALL_GLOWSHROOM_CAVE, SMALL_GLOWSHROOM_CAVE, List.of(CountPlacement.of(150), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), OffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome()));
