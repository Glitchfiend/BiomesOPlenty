...
public class ModLegacy
{
    public static void setupBlocks()
    {
        ...
        remap("rainbow_birch_sapling", Blocks.BIRCH_SAPLING);
        remap("rainbow_birch_leaves", Blocks.BIRCH_LEAVES);
        remap("origin_sapling", BOPBlocks.ORIGIN_OAK_SAPLING);
        remap("origin_leaves", BOPBlocks.ORIGIN_OAK_LEAVES);
        remap("rose", BOPBlocks.ORIGIN_ROSE);
        remap("potted_rose", BOPBlocks.POTTED_ORIGIN_ROSE);
        ...
        remap("potted_rainbow_birch_sapling", Blocks.POTTED_BIRCH_SAPLING);
    ...
    public static void setupBiomes()
    {
        ...
        remap("aspen_forest", BOPBiomes.PUMPKIN_PATCH);
        remap("aspen_glade", BOPBiomes.PUMPKIN_PATCH);
        remap("bamboo_grove", Biomes.CHERRY_GROVE);
        remap("bamboo_blossom_grove", Biomes.CHERRY_GROVE);
        remap("bayou_mangrove", BOPBiomes.BAYOU);
        remap("boreal_forest", BOPBiomes.PUMPKIN_PATCH);
        ...
        remap("clover_patch", BOPBiomes.SUBTROPICS);
        ...
        remap("grassland_clover_patch", BOPBiomes.SUBTROPICS);
        remap("gravel_beach", Biomes.STONY_SHORE);
        remap("grassland", BOPBiomes.SUBTROPICS);
        ...
        remap("jacaranda_forest", BOPBiomes.LAVENDER_FIELD);
        remap("jacaranda_glade", BOPBiomes.LAVENDER_FIELD);
        remap("lavender_forest", BOPBiomes.LAVENDER_FIELD);
        ...
        remap("seasonal_orchard", BOPBiomes.PUMPKIN_PATCH);
    ...
    public static void remap(String name, Block block)
    {
        BuiltInRegistries.BLOCK.wrapAsHolder(block).unwrapKey().ifPresent(key -> {
            Remapper.remap(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(BiomesOPlenty.MOD_ID, name)), key);
        });
    }

    public static void remap(String name, Item item)
    {
        BuiltInRegistries.ITEM.wrapAsHolder(item).unwrapKey().ifPresent(key -> {
            Remapper.remap(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(BiomesOPlenty.MOD_ID, name)), key);
        });
    }

    public static void remap(String name, ResourceKey<Biome> biome)
    {
        Remapper.remap(ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(BiomesOPlenty.MOD_ID, name)), biome);
    }
}
