...
public class ModVillagerTrades
{
    public static Holder<VillagerTrade> bootstrap(BootstrapContext<VillagerTrade> context) {
        ...
        context.register(WANDERING_TRADER_EMERALD_MAPLE_SAPLING, new VillagerTrade(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(BOPItems.MAPLE_SAPLING, 1), 8, 1, 0.05F, Optional.empty(), List.of()));
