...
public class ModJukeboxSongs
{
    ...
    {
        return ResourceKey.create(Registries.JUKEBOX_SONG, Identifier.fromNamespaceAndPath(BiomesOPlenty.MOD_ID, $$0));
    }
    ...
    private static void register(BootstrapContext<JukeboxSong> $$0, ResourceKey<JukeboxSong> $$1, Holder.Reference<SoundEvent> $$2, int $$3, int $$4)
    {
        ...
        $$0.register($$1, new JukeboxSong($$2, Component.translatable(Util.makeDescriptionId("jukebox_song", $$1.identifier())), (float)$$3, $$4));
    }
